...
echo ""
echo "Routes now available:"
echo "  /                          Homepage"
echo "  /article/{slug}            Individual article pages"
echo "  /category/{category}       Category listings"
echo "  /explore                   Knowledge graph"
echo "  /signatures                Disease signatures"
echo "  /matrix                    Evidence matrix"
echo "  /search?q={query}          Search results"
