...
sources: [zhou-2024-gut-microbiome-schizophrenia-mendelian-randomization, szeligowski-2020-gut-microbiome-schizophrenia-review, docimo-2020-human-microbiota-endocrinology-thyroid]
source_count: 3
metal_dependencies: [iron]
key_enzymes: [lactate dehydrogenase, methylmalonyl-CoA decarboxylase, propionate kinase]
tags: [firmicutes, negativicutes, lactate-utilizer, schizophrenia-protective, cross-feeding, SCFA-producer, family-level]
platform: wikibiome
seo_target: "Veillonellaceae lactate metabolism schizophrenia gut microbiome"
wikipedia_differentiation: "Mendelian randomization evidence establishing Veillonellaceae as causally protective against schizophrenia-associated violent behavior (OR 0.93); ecological role as lactate cross-feeders creating metabolic partnerships with Streptococcus; dual oral-gut significance connecting periodontal health to neuropsychiatric outcomes"
conditions_enriched_in: [schizophrenia]
conditions_depleted_in: [schizophrenia, hashimotos-thyroiditis]
...
- Family Veillonellaceae, order Veillonellales (sometimes Selenomonadales), class Negativicutes, phylum Firmicutes.
- Key genera: [[veillonella]], [[dialister]], Megasphaera, Selenomonas, Acidaminococcus.
- The Negativicutes are unusual Firmicutes: they are Gram-negative despite belonging to a predominantly Gram-positive phylum, possessing an outer membrane-like structure with lipopolysaccharide.
...
Paradoxically, some studies report Veillonellaceae enrichment in schizophrenia alongside Proteobacteria and Lactobacillaceae [[szeligowski-2020-gut-microbiome-schizophrenia-review]]. This apparent contradiction likely reflects the heterogeneity of schizophrenia subtypes, treatment effects, and the difference between genus-level (Veillonella vs. Dialister) and family-level analyses.

## Key Studies

- [[zhou-2024-gut-microbiome-schizophrenia-mendelian-randomization]] (Mendelian randomization, n=148,984) -- Established Veillonellaceae as causally protective against schizophrenia; part of the two-sided ecological engineering framework.
- [[szeligowski-2020-gut-microbiome-schizophrenia-review]] (review) -- Documented Veillonellaceae among taxa with inconsistent directionality across schizophrenia studies.
- [[docimo-2020-human-microbiota-endocrinology-thyroid]] (review) -- Reported Veillonellaceae depletion in Hashimoto's thyroiditis patients.
...
- [[hashimotos-thyroiditis]] -- Veillonellaceae depleted in HT patients
