...
sources:
  - motlagh-asghari-2023-saccharomyces-boulardii-ms-rct
  ...
  - hu-2022-gut-mycobiome-ckd-immunological-profiles
...
source_count: 11
tags: [probiotic-yeast, fungus, mycobiome, IBD, MS, NEC, ASD, CKD, anti-inflammatory, transient-colonizer]
seo_target: "Saccharomyces boulardii probiotic yeast gut microbiome"
wikipedia_differentiation: "Cross-condition probiotic evidence across MS (RCT), IBD (meta-analysis), NEC (meta-analysis), ASD, CKD mycobiome, and cardiometabolic disease — Wikipedia covers general probiotic use only"
gram_stain: "N/A (fungus)"
oxygen_requirement: "facultative anaerobe"
metal_dependencies: [zinc, manganese]
key_enzymes: [phosphatase, protease]
pathogenic_potential: "non-pathogenic"
...
*Saccharomyces boulardii* is a non-pathogenic yeast strain used as a probiotic across a wide range of gastrointestinal and inflammatory conditions. Taxonomically a strain of *S. cerevisiae*, it is phenotypically distinct — optimally active at 37°C (human body temperature), acid-resistant, and a transient colonizer that does not permanently establish in the gut. It is the most studied probiotic fungus and the only yeast with substantial clinical trial evidence across multiple disease contexts.

## Mechanism of Action

*S. boulardii* exerts probiotic effects through multiple mechanisms:
...
Meta-analysis evidence supports *S. boulardii* for maintaining remission in ulcerative colitis and Crohn's disease, with particular efficacy in preventing *C. difficile*-associated relapse [[shen-2014-probiotics-remission-uc-cd-pouchitis-meta-analysis]] [[mabrouk-2026-repurposing-gut-microbiota-modulators]].

### Necrotizing Enterocolitis

Meta-analysis of probiotics for NEC prevention in VLBW infants includes *S. boulardii* as a component of effective probiotic combinations [[zhou-2023-probiotics-prevent-nec-vlbw-meta]].

### Autism Spectrum Disorder

Discussed in reviews of probiotics for ASD via the gut-brain axis, though species-specific ASD trial data for *S. boulardii* alone is limited [[feng-2023-probiotics-asd-gut-brain-axis-review]].
