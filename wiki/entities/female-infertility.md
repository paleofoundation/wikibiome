...
wikipedia_differentiation: "Gut-ovarian axis concept showing causal microbiome-to-ovarian function links via FMT, Eggerthella-mediated ovarian fibrosis through beta-glucuronidase estrogen deconjugation, and bile acid depletion in follicular fluid as diagnostic biomarker for diminished ovarian reserve"
---
...
Bile acids produced by gut bacteria are measurable in follicular fluid and depleted in DOR:
- Lithocholic acid, chenodeoxycholic acid, ursodeoxycholic acid, deoxycholic acid, cholic acid all significantly lower
- 5-bile-acid panel achieves AUC = 0.964 for distinguishing DOR from normal reserve [[ding-2024-bile-acids-follicular-fluid-ovarian-reserve]]
...
1. Can targeted probiotic (B. longum) supplementation improve IVF outcomes in poor responders?
2. Does Eggerthella-targeting (antibiotic or probiotic competition) prevent or reverse POI?
3. Can microbiome-based prediction (bile acid panel, taxa profiles) identify infertility risk before clinical manifestation?
4. What is the relative contribution of gut vs. vaginal/endometrial microbiome to infertility?
5. Does cadmium-driven estrobolome dysfunction explain rising infertility rates in contaminated regions?
...
- [[pcos]] — PCOS phenotype transferable via FMT; shared signature exists
- [[endometriosis]] — shared metalloestrogen biology (Cd, Ni)
...
- [[metalloestrogens]] — Cd, Ni, As binding ERalpha
