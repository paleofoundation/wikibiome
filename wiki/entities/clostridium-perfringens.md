...
metal_dependencies: [iron, zinc, calcium]
key_enzymes: [alpha-toxin-phospholipase-C, perfringolysin-O, collagenase, hyaluronidase, sialidase]
pathogenic_potential: "opportunistic"
conditions_enriched_in: [necrotizing-enterocolitis, food-poisoning, gas-gangrene, pcos-vaginal]
...
- Non-toxigenic strains (pfoA-negative): These metabolize human milk oligosaccharides (HMOs), a capability previously thought to be restricted to *Bifidobacterium*. Cell-free supernatants from these strains inhibited NEC-associated Enterobacteriaceae (*E. coli*, *Enterobacter*, *Klebsiella*) by 40-90% in vitro. Genomic and proteomic analyses identified distinct HMO catabolic pathways absent in toxigenic strains ([[chapman-2026-clostridia-hmos-pathobiont-suppression-nec]], in-vitro).
...
Pathogenic *C. perfringens* diverts tryptophan toward the kynurenine pathway rather than serotonin synthesis. Since ~90% of the body's serotonin is produced in the gut from tryptophan, *C. perfringens* enrichment may contribute to serotonin depletion and mood dysregulation ([[dafini-2025-shatavari-neuro-gut-axis-ppd]], expert-opinion).
...
|-------|---------|---------------|
| [[chapman-2026-clostridia-hmos-pathobiont-suppression-nec]] | Non-toxigenic pfoA- strains metabolize HMOs, suppress Enterobacteriaceae 40-90% | In vitro |
| [[torrazza-2013-intestinal-microbial-ecology-nec]] | Detected in NEC stools; Proteobacteria bloom 2 weeks pre-NEC | Cross-sectional |
| [[zhou-2015-premature-infant-microbiome-prior-nec]] | Part of early/late NEC subtypes with distinct taxonomic signatures | Cross-sectional |
| [[zheng-2024-pcos-obesity-vaginal-microbiome-phages]] | Enriched in PCOS/obese vaginal microbiome | Cross-sectional |
| [[dafini-2025-shatavari-neuro-gut-axis-ppd]] | Diverts tryptophan to kynurenine; depletes serotonin | Expert opinion |

## Cross-References

- [[zinc]] -- alpha-toxin zinc dependency as virulence Achilles' heel
- [[iron]] -- iron-rich necrotic environments favor proliferation
- [[necrotizing-enterocolitis]] -- preterm infant disease association
- [[klebsiella-pneumoniae]] -- NEC pathobiont suppressed by non-toxigenic strains
