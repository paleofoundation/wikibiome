...
sources:
  ...
  - zhao-2025-gut-microbiota-pain-sensitization-review
  ...
  - minerbi-2020-gut-microbiome-pertinence-fibromyalgia-review
source_count: 8
...
- Bacteroides uniformis -- loss impairs polysaccharide degradation and immune regulation
- [[lachnospiraceae]] -- SCFA-producing family; depletion reduces colonocyte nutrition
...
- Does the elevated serum butyrate in FM reflect impaired colonocyte uptake, altered bacterial production, or both?
- Can the MR-validated copper-iron axis be targeted therapeutically (e.g., copper chelation + iron repletion)?
- What drives the strain-level functional divergence in Coprococcus 2 (butyrate-associated genus enriched in a butyrate-depleted state)?
- Is the FM microbiome signature causal, consequential, or both? FMT studies are needed.
