...
source_count: 10
tags: [pathogen, gram-negative, enterobacteriaceae, foodborne, iron-dependent, manganese, siderophores, co-selection, nickel, intracellular]
seo_target: "Salmonella iron manganese metal-dependent virulence"
wikipedia_differentiation: "Metal dependency profile across iron, manganese, zinc, and nickel linking nutritional immunity to Salmonella persistence strategies; co-selection of metal and antibiotic resistance; cadmium/lead exposure exacerbating Salmonella colitis"
gram_stain: "negative"
oxygen_requirement: "facultative anaerobe"
metal_dependencies: [iron, manganese, zinc, nickel]
key_enzymes: [salmochelin-synthase, SitABCD-manganese-transporter, MntH, type-III-secretion-system, NiFe-hydrogenase]
pathogenic_potential: "obligate"
conditions_enriched_in: [gastroenteritis, typhoid-fever]
...
- Salmochelin: A glucosylated derivative of enterobactin that evades host [[lipocalin-2]] — the primary counter-siderophore defense. This "stealth siderophore" strategy gives Salmonella a decisive advantage over organisms relying on enterobactin alone [[cassat-2012-metal-acquisition-staphylococcus-aureus]].
...
- MntH and SitABCD transport Mn2+ into the bacterial cell, where it serves as a cofactor for superoxide dismutase (SodA) — the primary defense against the oxidative burst [[martin-2022-manganese-homeostasis-stress-pathogenesis]].
...
- The ZntA zinc efflux pump is essential for intramacrophage survival, representing a host-pathogen arms race at the zinc level [[mcewan-2024-metalloproteome-plasticity-pathogen-adaptation]].
...
3. Environmental modulation: Cadmium and lead oral exposure exacerbates Salmonella-driven colitis by disrupting epithelial barrier integrity and altering the competitive landscape [[breton-2016-cadmium-lead-oral-exposure-colitis]].

Dietary iron supplementation in populations with endemic Salmonella increases infection severity — the supplemented iron overwhelms nutritional immunity and feeds the pathogen [[bushman-2025-nutrient-metals-bacteria-gut-infection]].

## Metal-Antibiotic Resistance Co-Selection

Salmonella is a major example of metal-antibiotic co-selection:

- The MdtABC efflux pump exports copper, zinc, AND multiple antibiotics in *S.* Typhimurium [[srivastava-2016-environmental-resistance-microbes-review]].
- Agricultural use of copper and zinc as growth promoters in livestock selects for multidrug-resistant Salmonella strains that enter the human food chain [[wales-2015-co-selection-resistance-antibiotics-biocides-metals]] [[baker-austin-2006-co-selection-antibiotic-metal-resistance]].
- Environmental nickel exposure selects for nickel-tolerant Salmonella with cross-resistance to fluoroquinolones [[genchi-2020-nickel-human-health-environmental-toxicology]].
