...
sources: [maini-rekdal-2019-microbiome-drug-interactions-parkinsons, miyake-2015-dysbiosis-ms-clostridia-depletion, jiang-2021-hrt-gut-microbiome-premature-ovarian-insufficiency, liu-2022-gut-microbiota-diversity-hashimotos, wehedy-2022-human-microbiome-ckd-double-edged-sword, maddu-2025-microbiome-drug-interactions-pharmacokinetic-review, bronzini-2023-feeding-gut-microbiome-ms, duarte-silva-2022-microbial-metabolites-ms, mohsen-2025-ms-gut-microbiome-immune-interaction]
source_count: 9
tags: [gram-positive, strict-anaerobe, drug-metabolism, levodopa, dopamine-dehydroxylation, uremic-toxin-producer, metal-tolerant-opportunist, estrogen-metabolism]
seo_target: "Eggerthella lenta gut microbiome drug metabolism levodopa"
wikipedia_differentiation: "Drug-metabolizing interspecies pathway with Enterococcus faecalis in levodopa degradation, metal-tolerant opportunist expansion in MS and CKD, and estrogen-related ovarian pathology via HRT-reversible enrichment"
platform: wikibiome
gram_stain: "positive"
oxygen_requirement: "anaerobic"
metal_dependencies: [iron, cobalt, molybdenum]
key_enzymes: [dopamine-dehydroxylase, cardiac-glycoside-reductase, beta-glucuronidase]
pathogenic_potential: "commensal-turned-pathogen"
conditions_enriched_in: [multiple-sclerosis, chronic-kidney-disease, premature-ovarian-insufficiency, hashimotos-thyroiditis]
...
1. **Competitor depletion**: When metal-sensitive Clostridia (clusters IV and XIVa) are depleted by heavy metal exposure or other stressors, *Eggerthella* fills the vacated anaerobic niches. This is the pattern observed in MS, where *E. lenta* increases alongside *Streptococcus* as Clostridia decline ([[miyake-2015-dysbiosis-ms-clostridia-depletion]], cross-sectional).

2. **Uremic environment**: In chronic kidney disease, the accumulation of urea and protein fermentation substrates favors proteolytic bacteria. *E. lenta* is consistently enriched in CKD patients and contributes to the production of uremic toxins including indoxyl sulfate and p-cresyl sulfate ([[wehedy-2022-human-microbiome-ckd-double-edged-sword]], expert-opinion).
