...
sources: [pei-2024-immune-cells-gut-microbiota-hashimotos-mendelian, li-2023-gut-microbiota-asd-bidirectional-mr, liu-2019-altered-microbiota-composition-asd-systematic-review, libbey-2018-diet-microbiota-eae, ma-2018-ketogenic-diet-neurovascular-function-gut-microbiome-mice, dai-2024-bidirectional-mr-gut-microbiota-cvd, hu-2024-gut-microbiota-chd-mendelian-randomization]
source_count: 7
metal_dependencies: [iron]
key_enzymes: [serotonin transporter interaction, bile acid metabolism enzymes]
tags: [firmicutes, erysipelotrichia, hashimotos-risk, ASD-associated, EAE-severity, serotonin-modulator, CHD-risk, ketogenic-diet-responsive, pro-inflammatory]
platform: wikibiome
seo_target: "Turicibacter serotonin gut microbiome Hashimoto's autoimmune disease"
wikipedia_differentiation: "Multi-disease MR evidence as risk factor for Hashimoto's thyroiditis (OR 1.16), ASD (OR 1.14), and coronary heart disease (OR 1.12); unique serotonin transporter interaction making Turicibacter a microbial modulator of host serotonin biology; EAE severity correlation linking Turicibacter to autoimmune neuroinflammation; dramatic 120-fold expansion on ketogenic diet in mice"
conditions_enriched_in: [hashimotos-thyroiditis, coronary-heart-disease]
conditions_depleted_in: [autism-spectrum-disorder, multiple-sclerosis]
...
*Turicibacter* is causally associated with increased HT risk (OR = 1.16, p = 0.020) [[pei-2024-immune-cells-gut-microbiota-hashimotos-mendelian]], alongside [[intestinimonas]] (OR 1.20). The serotonin-modulating capability of *Turicibacter* may be relevant: serotonin influences thyroid hormone synthesis and immune regulation in the thyroid gland.

### Coronary Heart Disease (Risk Factor)
*Turicibacter* increases CHD risk (OR = 1.12) via MR [[hu-2024-gut-microbiota-chd-mendelian-randomization]]. The bile acid metabolism function may link *Turicibacter* to cholesterol homeostasis and cardiovascular risk.
...
- [[pei-2024-immune-cells-gut-microbiota-hashimotos-mendelian]] (MR) -- HT risk factor (OR 1.16).
- [[hu-2024-gut-microbiota-chd-mendelian-randomization]] (MR) -- CHD risk factor (OR 1.12).
- [[li-2023-gut-microbiota-asd-bidirectional-mr]] (MR) -- Possible ASD association (OR 1.14).
- [[ma-2018-ketogenic-diet-neurovascular-function-gut-microbiome-mice]] (animal model) -- 120-fold ketogenic diet expansion.
- [[libbey-2018-diet-microbiota-eae]] (animal model) -- EAE severity correlation.

## Cross-References

- [[hashimotos-thyroiditis]] -- causal risk factor via MR
