...
The metallomic profile of T2D from the [[metal-disease-matrix]] is:
...
The role of trivalent chromium (Cr3+) in glucose metabolism remains one of the most contested questions in nutritional metallomics. The original "glucose tolerance factor" hypothesis held that Cr(III) is essential for insulin receptor activity and GLUT4 translocation. Khan 2014 reviewed evidence supporting this, noting that Cr deficiency elevates blood glucose and that supplementation may improve glycemic control. However, subsequent work has questioned whether Cr is truly essential in humans or whether observed effects reflect pharmacological doses rather than correction of deficiency. The distinction between essential Cr(III) and carcinogenic Cr(VI) adds complexity -- these are effectively different elements from a toxicological standpoint.

### Nickel: A Weak but Persistent Signal

The [[lu-2024-nickel-diabetes-meta-analysis|Lu et al. (2024)]] meta-analysis of 20 studies (46,071 participants) found a weak positive association between urinary nickel and diabetes risk (SMD 0.16, p<0.01) but no association for blood nickel (SMD 0.03, non-significant). This suggests nickel exposure rather than systemic nickel burden may be the relevant metric. Proposed mechanisms include increased hepatic glycogenolysis, heightened pancreatic glucagon release, reduced glucose utilization, and elevated inducible nitric oxide synthase. The association may differ at different disease stages, with blood nickel lower in prediabetic versus diabetic groups.
...
- [[metabolic-syndrome]] -- T2D shares metallomic features with obesity and cardiovascular disease; the Cu/Zn ratio is elevated across the metabolic syndrome spectrum
- [[pcos]] -- T2D is a major comorbidity of PCOS; both show insulin resistance, elevated Cu, and overlapping toxic metal exposures
- [[iron]] -- Ferritin-insulin resistance correlation; ferroptosis mechanisms shared with other Fe-overload diseases
- [[zinc]] -- ZnT8 transporter biology; Zn depletion as a cross-disease signature
- [[gut-metal-microbiome]] -- Metal-induced dysbiosis as an upstream driver of metabolic inflammation
