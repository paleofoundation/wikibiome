...
tags:
  ...
  - copper
  - manganese
seo_target: cholestasis bile acids gut microbiome
wikipedia_differentiation: >-
  Microbiome-bile acid feedback loop disruption, metal accumulation in cholestatic liver, and ecological consequences of
  lost bile flow
icd_10: K71.0
global_prevalence: Variable by etiology; intrahepatic cholestasis of pregnancy affects ~1-2% of pregnancies
signature_page: ''
associated_conditions:
  - primary-biliary-cholangitis
  - primary-sclerosing-cholangitis
  - non-alcoholic-fatty-liver-disease
shared_signature_metals:
  primary-biliary-cholangitis:
    - copper
    - manganese
    - iron
...
Cholestasis is a feature of [[cholestasis|primary-biliary-cholangitis]], [[cholestasis|primary-sclerosing-cholangitis]], and drug-induced liver injury. It also occurs in [[non-alcoholic-fatty-liver-disease]] progression. The shared metal accumulation pattern — particularly copper — across cholestatic conditions suggests a common metallotoxic pathway compounding the primary biliary insult.

## Open Questions

Whether microbiome restoration (via bile acid supplementation or targeted probiotics) can mitigate hepatic metal accumulation in chronic cholestasis is an emerging research question.

## Cross-References

- [[bile-acid-metabolism]] — disrupted enterohepatic circulation
- [[copper]] — hepatic accumulation in cholestasis
- [[manganese]] — biliary excretion impairment
- [[non-alcoholic-fatty-liver-disease|gut-liver-axis]] — bidirectional liver-microbiome signaling
