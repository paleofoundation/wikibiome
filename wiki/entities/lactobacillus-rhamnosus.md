...
tags:
  ...
  - NEC-prevention
  - SCFA
seo_target: Lactobacillus rhamnosus GG probiotic microbiome
wikipedia_differentiation: >-
  Metal detoxification capacity including cadmium and lead biosorption; strain-level differences in therapeutic efficacy
  (GG vs. other rhamnosus strains); bovine lactoferrin + LGG as top-ranked NEC prevention combination (SUCRA 95.7%);
  heavy metal binding mechanism via cell wall peptidoglycan and teichoic acids
gram_stain: positive
