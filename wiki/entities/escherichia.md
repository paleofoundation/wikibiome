...
source_count: 8
tags: [gram-negative, enterobacteriaceae, iron-dependent, siderophores, LPS, curli-amyloid, dysbiosis-marker, estrobolome, beta-glucuronidase, nickel-hydrogenase]
seo_target: "Escherichia coli gut microbiome iron siderophores dysbiosis"
wikipedia_differentiation: "Genus-level overview connecting Escherichia/Shigella complex as the universal dysbiosis bloom marker, with metal-dependent virulence (iron siderophores, nickel hydrogenases), curli amyloid cross-seeding in neurodegeneration, and estrobolome activity — perspectives absent from Wikipedia"
gram_stain: "negative"
oxygen_requirement: "facultative anaerobe"
metal_dependencies: [iron, nickel, zinc]
key_enzymes: [enterobactin-synthase, NiFe-hydrogenase, beta-glucuronidase, curli-CsgA]
pathogenic_potential: "commensal-turned-pathogen"
conditions_enriched_in: [inflammatory-bowel-disease, colorectal-cancer, cardiovascular-disease, autism-spectrum-disorder, endometriosis, necrotizing-enterocolitis]
...
- IBD: Enriched in both Crohn's and UC; AIEC strains colonize ileal mucosa [[khorsand-2022-enterobacteriaceae-ecoli-ibd-ibdmdb-metagenomics]] [[wang-2024-ibd-integrated-16s-metagenomics-virulence-factors]].
- CRC: Enriched in tumor tissue; certain strains produce colibactin (genotoxin) [[gao-2015-microbiota-disbiosis-colorectal-cancer]].
- CVD: Part of Enterobacteriaceae bloom in atherosclerosis [[jie-2017-gut-microbiome-acvd]].
- ASD: Enriched in gut microbiota of ASD children [[strati-2017-altered-gut-microbiota-mycobiota-asd]].
...
- Estrogen recirculation: Possesses beta-glucuronidase activity, deconjugating estrogens in the gut and contributing to the [[estrobolome]] [[kaliannan-2018-estrogen-gut-microbiome-metabolic-syndrome]].

## Cross-References

- [[escherichia-coli]] — species page
- [[adherent-invasive-e-coli]] — pathogenic AIEC variant
