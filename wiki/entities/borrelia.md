...
sources:
  ...
  - bazzichi-2024-environmental-factors-fibromyalgia-review
...
source_count: 8
tags: [spirochete, Lyme-disease, tick-borne, iron-free, manganese-dependent, MnSOD, H-Mn-complexes, nutritional-immunity-evasion, radiation-sensitive]
...
key_enzymes: [MnSOD-superoxide-dismutase, H-Mn-metabolite-complexes]
pathogenic_potential: obligate
conditions_enriched_in: [lyme-disease, neuroborreliosis, lyme-arthritis]
...
*Borrelia burgdorferi* does not accumulate [[iron]] and lacks iron-dependent enzymes ([[londono-2025-epr-manganese-antioxidant-borrelia-burgdorferi]], quasi-experimental). This is not merely iron tolerance -- it is a wholesale elimination of one of biology's most fundamental transition metal cofactors. The evolutionary logic is elegant:
...
Having abandoned iron, *Borrelia* has built its entire antioxidant defense on [[manganese]]. EPR (electron paramagnetic resonance) and ENDOR spectroscopy reveal two complementary Mn-based antioxidant systems operating in living cells ([[londono-2025-epr-manganese-antioxidant-borrelia-burgdorferi]], quasi-experimental):

| Mn Pool | EPR Signature | Identity | Function | Location |
|---|---|---|---|---|
| L-Mn | Broad, featureless | MnSOD (enzyme-bound) | Catalytic O2-- dismutation | Cell surface |
| H-Mn | Narrow, 6-peak | Mn2+-metabolite complexes | Non-enzymatic O2-- scavenging | Cytoplasm |
...
| H-Mn complexes | Manganese | Non-enzymatic cytoplasmic antioxidant |
...
| Organism | Iron Use | Mn Use | Antioxidant Strategy | Radioresistance |
|---|---|---|---|---|
| *B. burgdorferi* | None | High (90% L-Mn) | MnSOD dominant | Low |
| *D. radiodurans* | Low | Very high (>90% H-Mn) | H-Mn complexes dominant | Very high |
| *E. coli* | High | Low (90% L-Mn) | Fe-SOD + catalase | Low |
| *L. plantarum* | Low | High (>90% H-Mn) | H-Mn complexes | High |
...
- [[londono-2025-epr-manganese-antioxidant-borrelia-burgdorferi]] (quasi-experimental) -- Uses EPR/ENDOR spectroscopy to directly observe Mn speciation in living *B. burgdorferi* cells; discovers dual MnSOD/H-Mn antioxidant system; demonstrates Mn toxicity under metabolite depletion; establishes *Borrelia* as a natural experiment in iron-free biology.
