...
sources: [li-2023-gut-microbiota-asd-bidirectional-mr, pendergrass-2026-microbial-metallomics-parkinsons-ferroptosis, romano-2021-meta-analysis-gut-microbiome-parkinsons]
source_count: 3
metal_dependencies: [iron]
key_enzymes: [peptidases, glycoside hydrolases, succinate dehydrogenase]
tags: [bacteroidetes, bacteroidia, SCFA-producer, fiber-fermenter, ASD-risk, parkinsons-depleted, family-level, schizophrenia-enriched]
platform: wikibiome
seo_target: "Prevotellaceae gut bacteria Parkinson's disease autism fiber microbiome"
wikipedia_differentiation: "Bidirectional MR evidence showing Prevotellaceae causally increases ASD risk (OR 1.24, FDR-significant) while being the most consistently depleted family in Parkinson's disease; the paradox of a fiber-fermenting SCFA-producer being a risk factor in one neurological condition and protective in another; schizophrenia enrichment in violent behavior phenotype"
conditions_enriched_in: [autism-spectrum-disorder, schizophrenia]
conditions_depleted_in: [parkinsons-disease, depression]
