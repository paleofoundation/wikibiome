...
sources: [maier-2019-nickel-microbial-pathogenesis, shi-2023-ppi-fungal-dysbiosis-gerd, dong-2018-ppi-acid-test-microbiome-composition-editorial]
source_count: 3
...
icd_10: "K25"
global_prevalence: "5-10% lifetime risk"
signature_page: ""
associated_conditions: [gerd, gastric-adenocarcinoma, duodenal-ulcer]
shared_signature_metals: {gastric-adenocarcinoma: [nickel, iron]}
shared_signature_taxa: {gastric-adenocarcinoma: [helicobacter-pylori]}
---
...
- **Nickel-urease** constitutes up to 10% of the total *H. pylori* proteome and catalyzes urea hydrolysis to ammonia and bicarbonate, neutralizing gastric acid in the immediate periplasmic environment [[maier-2019-nickel-microbial-pathogenesis]].
...
- **NiFe-hydrogenase** provides metabolic energy by oxidizing molecular hydrogen (H2), which is chronically available in the human stomach at approximately 80 microM. This energy powers the type IV secretion system and CagA translocation [[maier-2019-nickel-microbial-pathogenesis]].
...
*H. pylori* acquires nickel through dedicated transport systems including **NixA** (a high-affinity nickel permease) and **NiuBDE** (an ABC-type transporter). These [[nickel-transporters]] represent potential therapeutic targets -- blocking nickel uptake disables both urease and hydrogenase simultaneously, crippling the organism's ability to colonize the gastric niche [[maier-2019-nickel-microbial-pathogenesis]].
...
- Proton pump inhibitor (PPI) therapy, the standard treatment for gastric ulcers, raises gastric pH and permits colonization by oral and intestinal bacteria not normally found in the stomach [[dong-2018-ppi-acid-test-microbiome-composition-editorial]].
- PPI use also disrupts the gastric mycobiome, potentially promoting fungal overgrowth by *Candida* species [[shi-2023-ppi-fungal-dysbiosis-gerd]].
...
- [[helicobacter-pylori]] -- primary microbial cause
- [[nickel]] -- essential metal for *H. pylori* virulence enzymes
- [[nickel-transporters]] -- NixA and NiuBDE as therapeutic targets
- [[gastric-adenocarcinoma]] -- downstream malignant progression
- [[gerd]] -- related upper GI condition
- [[nutritional-immunity]] -- host nickel sequestration as potential defense
