...
tags:
  ...
  - infant-colonizer
  - cadmium-binding
seo_target: Bifidobacterium longum probiotic heavy metal detox microbiome
wikipedia_differentiation: >-
  Heavy metal biosorption capacity (Cd, Pb, Hg binding via cell wall EPS and peptidoglycan); prenatal lead exposure
  depletes B. longum in childhood microbiome years later; B. longum abundance predicts IVF ovarian stimulation response;
  subspecies-level functional differences (longum vs. infantis) in HMO degradation and immune programming
gram_stain: positive
