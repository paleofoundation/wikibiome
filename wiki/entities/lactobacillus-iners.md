...
sources: [chao-2021-vaginal-microbiome-chronic-pelvic-pain-endometriosis, macsharry-2024-endometriosis-vaginal-microbiota-n-glycome, zheng-2024-pcos-obesity-vaginal-microbiome-phages, asangba-2023-microbiome-ovarian-cancer-diagnostic-prognostic, chen-2021-chlamydia-vaginal-microbiota-tubal-infertility]
source_count: 5
tags: [gram-positive, vaginal-microbiome, dysbiosis-marker, lactic-acid-producer, community-state-type-III, endometriosis, pcos, ovarian-cancer, not-protective]
seo_target: "Lactobacillus iners vaginal microbiome dysbiosis marker not protective"
wikipedia_differentiation: "Evidence-based reclassification from protective Lactobacillus to dysbiosis marker with failure to suppress pathogens (Chlamydia, S. aureus), enrichment in gynecological cancers and endometriosis, and mechanistic distinction from truly protective L. crispatus including cholesterol-dependent cytolysin production"
platform: wikibiome
gram_stain: "positive"
oxygen_requirement: "facultative"
metal_dependencies: [manganese, iron]
key_enzymes: [inerolysin, L-lactate-dehydrogenase]
pathogenic_potential: "commensal-turned-pathogen"
conditions_enriched_in: [endometriosis, ovarian-cancer, pcos, bacterial-vaginosis-transitional, tubal-infertility]
...
- [[pcos|polycystic-ovary-syndrome]] -- vaginal dysbiosis component
- [[chlamydia-trachomatis]] -- pathogen not suppressed by L. iners
- [[bacterial-vaginosis]] -- transitional state toward BV
- [[bacterial-vaginosis|vaginal-microbiome]] -- community state type classification
