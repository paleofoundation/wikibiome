...
A critical clinical insight from the signature analysis: hepcidin is elevated in endometriosis, indicating the body is deliberately withholding iron from pathogens. Low serum iron in endometriosis patients represents a **host defense strategy (functional anemia), not a nutritional deficiency**. This has direct therapeutic implications -- iron supplementation may be counterproductive (see STOPs below).
...
[[lopez-botella-2023-peritoneal-fluid-metals-endometriosis|Lopez-Botella et al. (2023)]] documented dramatically elevated peritoneal fluid metals in an endometriosis patient following a vegetarian diet with no occupational exposure. The case is instructive: the patient's lacto-ovo vegetarian diet rich in tomatoes, hazelnuts, walnuts, almonds, and olive oil provided a high-nickel dietary load that accumulated in the peritoneal environment.

Sources of the metal burden include:
- **Diet** (largest contributor): Zn, Fe, Ni, Cd, Pb through plant-based foods, nuts, legumes, whole grains
- **Brassica vegetables**: Cadmium, lead, zinc, and nickel hyperaccumulators; increased brassica consumption was found as a **risk factor** for endometriosis
- **Retrograde menstruation**: Fe exposure to the peritoneal microenvironment
- **Smoking**: Cd, Pb, Ni
...
Endometriosis presents two of the most striking dietary paradoxes in metallomics.

### The Plant-Based Diet Paradox

[[barnard-2023-nutrition-prevention-treatment-endometriosis|Barnard et al. (2023)]] reviewed evidence that plant-based diets reduce circulating estrogen by 10-25% through increased fiber, which should benefit this estrogen-dependent disease. A low-fat vegan diet increased sex-hormone binding globulin and reduced dysmenorrhea severity. Yet the plant-based foods recommended -- legumes, whole grains, nuts, soy, leafy greens -- are among the highest-nickel foods. For the 90.3% of endometriosis patients with nickel sensitivity, following standard plant-based dietary guidance may paradoxically worsen gastrointestinal and gynecological symptoms by increasing the very metal that drives nickel-dependent pathogen virulence.

The resolution may lie in **selective plant-based eating**: choosing low-nickel plant foods (most fruits, some vegetables, rice) while avoiding high-nickel plant foods (legumes, nuts, cocoa, whole wheat), combined with cooking in non-stainless-steel vessels.

### The Zinc-MMP Tissue Invasion Paradox

[[huang-2024-zinc-intake-endometriosis-risk|Huang et al. (2024)]] found that higher dietary zinc intake (>14 mg/day) was associated with a **60% increased odds of endometriosis** (OR 1.6, 95% CI 1.12-2.27) in NHANES data (4,315 women). This is counterintuitive given zinc's antioxidant and anti-inflammatory roles. The resolution lies in the dual nature of zinc in endometriosis:

- **Zinc feeds MMPs**: Matrix metalloproteinases (MMP-2, MMP-9) are zinc-dependent enzymes that facilitate the tissue invasion and remodeling central to endometriotic lesion establishment.
- **Zinc feeds pathogen metalloproteases**: The zinc-dependent virulence enzymes of E. coli and B. fragilis (BFT toxin) use zinc to degrade host tissues.
- **Calprotectin is already sequestering zinc**: The host's nutritional immunity response elevates calprotectin specifically to chelate zinc away from pathogens. Zinc supplementation may undermine this defense.

This is why the endometriosis signature includes a **STOP** for zinc supplementation despite low serum zinc levels.

### The H2S/NF-kB Amplification Loop

[[lei-2018-h2s-endometrial-stromal-cells-nfkb|Lei et al. (2018)]] demonstrated that hydrogen sulfide promotes endometrial stromal cell proliferation via NF-kB activation. CBS and CSE (H2S-producing enzymes) are overexpressed in ectopic endometrium. NF-kB is also activated by nickel exposure in allergic contact mucositis. This creates a convergent pathway: dietary nickel activates NF-kB in the gut mucosa; H2S from endometriotic lesions activates NF-kB locally; both feed the same inflammatory cascade that promotes lesion growth. Inhibiting endogenous H2S production in vivo significantly reduced lesion number and weight in a mouse model.

## Developmental Vulnerability

Endometriosis onset typically occurs during adolescence and early reproductive years, a period of high estrogen activity and ongoing reproductive tract development. Prenatal and pubertal exposure to metalloestrogens (Cd, Ni) during these windows may prime susceptibility. No studies have evaluated chronic low-dose metalloestrogen exposure during puberty specifically in relation to endometriosis risk -- this remains a critical gap. See [[developmental-metal-vulnerability]].
...
|-------------|-----------|
| **[[low-nickel-diet]]** | Disables Ni-dependent glyoxalase, urease, hydrogenase; reduces Candida co-aggregate biofilm biomass; all 15 GI, 7 extra-intestinal, and 3 gynecological symptoms improved significantly |
| **[[low-red-meat-diet]]** | Reduces free iron and zinc available to pathogens |
| **[[low-fat-diet]]** | Reduces E. coli growth; lowers circulating estrogen by 10-25% |
...
| **[[lactoferrin-supplementation]]** | Supports nutritional immunity; chelates iron + nickel from pathogens; alternative to iron supplementation |
| **NAC supplementation** | Replenishes depleted glutathione -- the only factor neutralizing Cd and Pb |
...
1. **Nickel allergy as diagnostic tool**: Should Ni ACM testing (Ni omPT) become standard in the endometriosis workup, given 90.3% prevalence in symptomatic patients?
2. **HBOT in humans**: Complete remission in animal models via disrupting the hypoxic niche -- when will this be clinically investigated?
3. **Vegetarian diet modification**: Can a modified "low-nickel vegetarian" diet capture the estrogen-lowering benefits of plant-based eating while avoiding nickel-driven symptom exacerbation?
...
- [[developmental-metal-vulnerability]] -- Pubertal metalloestrogen exposure and endometriosis susceptibility
