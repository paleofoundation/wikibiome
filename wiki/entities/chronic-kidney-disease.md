...
A progressive loss of kidney function affecting approximately 850 million people worldwide (10-15% of adults). CKD is unique among diseases in this wiki because it occupies **both sides of the metal-disease equation**: heavy metals (Cd, Pb, Hg, As) directly cause nephrotoxic injury, AND kidney dysfunction impairs metal excretion, creating a **vicious cycle** of accumulation and damage. Approximately 29 source pages address CKD's metallomic dimensions, including the enigmatic entity of CKD of unknown cause (CKDu) in agricultural communities.
...
- **Racial disparities**: Black race dramatically modifies the Pb-CKD association -- 10 mL/min per 1.73m2 lower eGFR associated with **0.13 ug/dL more Pb among Black participants vs 0.03 among White** (4x stronger association) [[danziger-2022-susceptibility-heavy-metal-toxicity-ckd]].
...
The gut-kidney axis is relevant to CKD metallomic research through several pathways:

- Uremic toxins accumulate in CKD and alter gut microbiota composition.
- Heavy metals (Pb, Cd, As, Cr, Hg) disrupt gut barrier integrity, reducing tight junction proteins (ZO-1, occludin, claudin-1) [[ghosh-2023-heavy-metals-gut-barrier-integrity]].
- Gut barrier disruption enables bacterial translocation and endotoxemia, worsening systemic inflammation and renal injury.
- Metal-sequestering probiotics (Lactobacillus, Bifidobacterium) can reduce metal bioavailability in the gut, potentially reducing nephrotoxic load [[duan-2020-gut-microbiota-heavy-metal-probiotic-strategy]].
- Cd at low doses specifically decreases Akkermansia muciniphila, a gut barrier-protective species [[ghosh-2023-heavy-metals-gut-barrier-integrity]].
...
| Chelation therapy | Limited clinical evidence | Reduce metal body burden; but must balance against renal clearance capacity |
...
5. **Can metallomic profiling predict CKD progression?** If specific metal patterns (e.g., rising blood Pb with falling urinary Pb) signal decompensation, they could become early warning biomarkers.
