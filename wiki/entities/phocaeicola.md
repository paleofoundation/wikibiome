...
sources: [huang-2024-fmt-pcos-metabolic-ovarian-dysfunction, al-bataineh-2023-multi-omics-microbiome-metabolome-t2d-fiber, bibbo-2025-fmt-capsules-ms-case-report, zhang-2026-metagenomic-gut-microbiome-diabetes-mi]
source_count: 4
metal_dependencies: [iron]
key_enzymes: [polysaccharide utilization loci (PUL), beta-glucosidase, succinate dehydrogenase]
tags: [bacteroidota, bacteroidia, recently-reclassified, PCOS-enriched, FMT-transferred, T2D-discriminating, MS-colonizer, ex-bacteroides]
platform: wikibiome
seo_target: "Phocaeicola Bacteroides reclassification PCOS gut microbiome FMT"
wikipedia_differentiation: "FMT evidence demonstrating that PCOS fecal microbiota enriched in Phocaeicola recapitulates the full PCOS phenotype (insulin resistance, ovarian dysfunction) when transferred to germ-free mice; T2D disease-discriminating taxon in multi-omics analysis; MS colonizer appearing from 0% at baseline after FMT capsule treatment; the reclassification story illustrating why taxonomic revision matters for clinical microbiome interpretation"
conditions_enriched_in: [polycystic-ovary-syndrome, type-2-diabetes]
...
- [[huang-2024-fmt-pcos-metabolic-ovarian-dysfunction]] (animal model/FMT) -- PCOS phenotype transfer via Phocaeicola-enriched microbiota.
- [[al-bataineh-2023-multi-omics-microbiome-metabolome-t2d-fiber]] (cross-sectional) -- T2D disease-discriminating taxon.
- [[bibbo-2025-fmt-capsules-ms-case-report]] (case report) -- Rapid colonization after FMT in MS patient.
- [[zhang-2026-metagenomic-gut-microbiome-diabetes-mi]] (cross-sectional) -- Key discriminative species in diabetes-MI comorbidity.
