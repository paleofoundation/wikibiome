...
sources: [davis-richardson-2015-bacteroides-dorei-t1d-model, vatanen-2018-teddy-gut-microbiome-t1d-nature, brown-2011-gut-metagenomics-t1d-autoimmunity-model, knip-2017-modulation-t1d-risk-intestinal-microbiome]
source_count: 4
tags: [genus, Bacteroidetes, polysaccharide-degradation, propionate, PSA, bile-acid, LPS-variant, commensal, pathobiont]
platform: wikibiome
seo_target: "Bacteroides gut microbiome species"
wikipedia_differentiation: "B. dorei TLR4-antagonist LPS preventing immune education (T1D); species-level functional divergence within a single genus (B. fragilis immunomodulatory PSA vs. BFT toxin); capsular polysaccharide switching enabling immune evasion; Bacteroides as dominant glycan degraders with metal-dependent enzymes"
gram_stain: "negative"
oxygen_requirement: "obligate anaerobe"
metal_dependencies: [iron, zinc]
key_enzymes: [polysaccharide-utilization-loci, beta-glucuronidase, bile-salt-hydrolase]
pathogenic_potential: "commensal-turned-pathogen"
conditions_enriched_in: [type-1-diabetes, obesity]
conditions_depleted_in: [crohns-disease]
---
...
- *B. dorei* enrichment in infants precedes T1D development; its immunoinhibitory LPS may impair immune maturation [[davis-richardson-2015-bacteroides-dorei-t1d-model]].
- The TEDDY study confirmed Bacteroides-dominant early gut microbiomes as a T1D risk factor [[vatanen-2018-teddy-gut-microbiome-t1d-nature]].
