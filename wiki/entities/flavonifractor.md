...
title: Flavonifractor
type: entity
subtype: microbe
created: 2026-04-14
updated: 2026-04-16
last_substantive_update: 2026-04-16
sources: [minerbi-2019-altered-microbiome-fibromyalgia, goudman-2024-gut-dysbiosis-chronic-pain-meta-analysis, shtrozberg-2025-gut-microbiome-fibromyalgia-review, wang-2023-perturbed-microbiome-metabolomes-ckd-severity, zhang-2023-metagenome-esrd-microbiome-uremic-toxins, thirion-2023-gut-microbiota-ms-disease-activity, wang-2023-gut-microbiota-signature-asd-gi-symptoms-china]
source_count: 7
tags: [flavonifractor, flavonoid-degrader, enriched-in-disease, fibromyalgia, CKD, polyphenol-neutralizer, ruminococcaceae]
platform: wikibiome
gram_stain: "positive"
oxygen_requirement: "obligate anaerobe"
metal_dependencies: [iron, cobalt]
key_enzymes: [flavonoid reductase, chalcone isomerase, enoate reductase, cytochrome b-like flavoprotein]
pathogenic_potential: "commensal-turned-pathogen"
conditions_enriched_in: [fibromyalgia, chronic-kidney-disease, autism-spectrum-disorder, multiple-sclerosis]
conditions_depleted_in: []
seo_target: "Flavonifractor plautii gut microbiome disease"
wikipedia_differentiation: "Degrades dietary flavonoids (anti-inflammatory polyphenols) removing their protective effects; enriched in fibromyalgia (correlated with symptom severity), CKD (progression marker), and ASD; metal-dependent reductase enzymes explain its selective advantage in dysbiotic environments; represents a mechanism by which dysbiosis neutralizes dietary interventions"
---
...
- *Flavonifractor* enrichment increases with CKD staging; enriched alongside *Citrobacter* as a dysbiotic marker while *Faecalibacterium prausnitzii* and *Eubacterium rectale* are depleted [[wang-2023-perturbed-microbiome-metabolomes-ckd-severity]].
...
- *Flavonifractor* also appears in ESRD (end-stage renal disease) microbiome analyses as part of the uremic dysbiosis pattern [[zhang-2023-metagenome-esrd-microbiome-uremic-toxins]].

### Multiple Sclerosis

- Present in MS-associated gut dysbiosis signatures, consistent with its pattern of enrichment in neuroinflammatory conditions [[thirion-2023-gut-microbiota-ms-disease-activity]].
