...
sources: []
source_count: 0
tags: [flavonifractor, flavonoid-degrader, enriched-in-disease, fibromyalgia, CKD]
platform: wikibiome
gram_stain: "positive"
oxygen_requirement: "obligate anaerobe"
metal_dependencies: []
key_enzymes: [flavonoid reductase, chalcone isomerase]
pathogenic_potential: "commensal-turned-pathogen"
conditions_enriched_in: [fibromyalgia, chronic-kidney-disease]
conditions_depleted_in: []
seo_target: "Flavonifractor plautii gut microbiome disease"
wikipedia_differentiation: "Degrades dietary flavonoids (anti-inflammatory polyphenols) removing their protective effects; enriched in fibromyalgia (correlated with symptom severity) and CKD (progression marker), representing a mechanism by which dysbiosis neutralizes dietary interventions"
---
...
- [[butyrate]] -- SCFA production ecosystem that *Flavonifractor* disrupts indirectly
