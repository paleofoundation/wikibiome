...
sources: [yoshida-2023-pathogens-saliva-cp-adolescents, fitzjerrells-2025-oral-dysbiosis-hypotaurine-ms, yu-2022-systematic-review-microbial-markers-colorectal-neoplasia, zou-2024-multi-omic-microbiome-genome-transcriptome-crc]
source_count: 4
tags: [oral-pathogen, periodontopathogen, gram-negative, anaerobic, heme-dependent, iron-acquisition, pigmented, oral-gut-axis]
seo_target: "Prevotella intermedia periodontal disease oral microbiome iron heme"
wikipedia_differentiation: "Iron/heme-dependent pigmentation as metal sequestration strategy; enrichment in MS oral microbiome as Gram-negative pathobiont; CRC-enriched species distinct from gut Prevotella commensals; cerebral palsy periodontal pathogen"
platform: wikibiome
gram_stain: "negative"
oxygen_requirement: "anaerobic"
metal_dependencies: [iron]
key_enzymes: [hemolysins, proteases, lipopolysaccharide, heme-binding-proteins]
pathogenic_potential: opportunistic
conditions_enriched_in: [periodontal-disease, multiple-sclerosis, colorectal-cancer, cerebral-palsy]
...
In a cross-sectional study of adolescents with cerebral palsy, *P. intermedia* was detected alongside other periodontopathogens, with significant quantitative differences between control groups with and without gingivitis ([[yoshida-2023-pathogens-saliva-cp-adolescents]], cross-sectional, n=65). The neurologically impaired population showed elevated periodontal pathogen burdens, likely due to compromised oral hygiene and altered salivary function.
...
*P. intermedia* is among the CRC-enriched species identified through multi-omic profiling (metagenomics + exome sequencing + transcriptomics) of matched tumor and stool samples ([[zou-2024-multi-omic-microbiome-genome-transcriptome-crc]], cross-sectional, n=41). A systematic review also identified oral *P. intermedia* as consistently associated with CRC risk through serum antibody studies ([[yu-2022-systematic-review-microbial-markers-colorectal-neoplasia]], systematic-review-meta-analysis).
