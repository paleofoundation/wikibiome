...
sources:
  - ncbi-taxonomy-agathobacter-rectalis
  - lpsn-agathobacter-rectalis
  - rosero-2016-agathobacter-rectalis-reclassification
  - sheridan-2016-objections-agathobacter-rectalis
  - vatanen-2018-teddy-gut-microbiome-t1d-nature
  - mendoza-leon-2023-scfas-thyroid-function
...
source_count: 15
tags: [Agathobacter, Lachnospiraceae, butyrate-producer, taxonomy, eubacterium-rectale-historical-name, source-label-boundary]
seo_target: Agathobacter rectalis NCBITaxon 39491 Eubacterium rectale historical name
wikipedia_differentiation: Current Agathobacter rectalis identity reconciled with source-era Eubacterium rectale labels and the published objection to the transfer
platform: wikibiome
gram_stain: positive
...
ncbi_taxonomy_id: 39491
historical_names: [Eubacterium rectale, Roseburia rectale]
---

# *Agathobacter rectalis*

*Agathobacter rectalis* (Hauduroy et al. 1937) Rosero et al. 2016 is the selected current name for NCBITaxon:39491. NCBI Taxonomy lists *Eubacterium rectale* as a homotypic synonym, and LPSN identifies *A. rectalis* as the correct validly published combination [[ncbi-taxonomy-agathobacter-rectalis]] [[lpsn-agathobacter-rectalis]]. Rosero and colleagues proposed the transfer to the new genus *Agathobacter* using phenotypic, chemotaxonomic, 16S rRNA, and housekeeping-gene evidence [[rosero-2016-agathobacter-rectalis-reclassification]].

## Nomenclature and Published Disagreement

The transfer has not been free of scientific disagreement. Sheridan and colleagues objected that the evidence did not adequately support moving the narrowed human-gut species definition into the proposed genus [[sheridan-2016-objections-agathobacter-rectalis]]. WikiBiome follows the current NCBI and LPSN selection for canonical naming while retaining that published limitation. Canonicalization therefore records the selected nomenclatural convention; it does not claim unanimous phylogenetic agreement.
