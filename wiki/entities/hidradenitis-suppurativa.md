...
seo_target: hidradenitis suppurativa gut microbiome skin
wikipedia_differentiation: >-
  Mendelian randomization evidence for causal gut microbiome taxa in HS: Clostridium innocuum group (OR 2.17) and
  Lachnospira (OR 2.45); 40% gut microbiota overlap with Crohn's disease configuration; gut-skin axis as mechanistic
  framework
icd_10: L73.2
global_prevalence: ~1-4% globally
signature_page: ''
...
- [[intestinal-permeability|barrier-dysfunction]] — gut permeability as route for systemic inflammation affecting skin
