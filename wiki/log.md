...
2026-05-04 — Ingest session: 5 NEC sources ingested (lin-2023, ran-ressler-2011, stewart-2013, till-2015, agakidou-2020). NEC entity updated (source_count 8→13, new sections: two-pattern dysbiosis, pre-NEC prediction, BCFA/vernix, biomarkers). New stub: methylobacterium. CRITICAL FIX: raw.zip (11GB) added to .vercelignore — was blocking all nightly deploys for 12 consecutive nights. Deploy to wikibiome.com succeeded.

2026-05-04 — Ingest session (continued): 5 more NEC sources ingested — martin-2011-bile-acids-mucin2-nec (animal-model: ASBT upregulation → bile acid accumulation → Muc2 depletion; cholestyramine normalizes Muc2), hulzebos-2017-fecal-bile-salts-nec-preterm (case-control n=10+20: unconjugated fecal BA 3-4x elevated, 5-6 day pre-diagnostic window, 93% sensitivity at >13 μmol/g), stewart-2013-bacterial-fungal-viability-preterm-nec (prospective-cohort n=32: Sphingomonas assoc. p=0.0001, fungi non-viable under fluconazole, antibiotic richness nadir week 4), manohar-2023-gut-brain-nec-neurodevelopmental (review: LPS→TLR4→NF-κB→BBB→microglial activation→white matter injury; surgical>medical NEC for NDI), brower-sinning-2014-mucosa-bacterial-diversity-nec (case-control n=19: first tissue-level NEC microbiome; two phenotypes: Enterobacteriaceae cluster vs obligate anaerobe cluster; C. perfringens 2 OTUs; KEYSTONE criteria 1,2,4). NEC entity updated (source_count 13→18, bile acid ecology section, gut-brain axis/NDI section, Sphingomonas, mucosa-associated dysbiosis). NEC signature exits stub status (0→10 sources). New entity: sphingomonas.md (stub). C. perfringens entity source updated. All 7 commits passed build. Full vite+static build clean (867 pages).

2026-09-04 — Technical SEO: removed catch-all SPA rewrite (soft 404s), unique special-page HTML + self-canonicals, 404.html noindex, stub/thin noindex + sitemap exclusion, www host + trailingSlash:false, robots/image-sitemap alignment, Stripe lazy-init to stop API 5xx on missing key. See PR.
2026-09-04 — Host normalization: live curl confirmed https://wikibiome.com/ (and article paths) return 200 with 0 redirects while sitemaps/canonicals use www. Added explicit `/` + `/:path*` 301s and Node middleware so apex→www is one hop (path + query preserved; preview hosts untouched).
2026-09-04 — GSC sample URLs (sc-domain, 2026-09-04): 301 /signature-explorer → /signatures (stop Babel HTML 5xx); 301 DNA-damage → dna-damage; 301 autism-spectrum-disorder-microbiome-signature → autism-spectrum-disorder-signature; 410 for 5 never-public /article/ source and invented slugs; 404.html stays noindex and does not canonical to /. Apex host-split URLs (glyoxalase, desulfovibrio, enterobacteriaceae, zinc-supplementation, CRC, nickel, endometriosis) covered by existing one-hop apex→www 301.
2026-09-04 — Vercel preview failed on HEAD (vercel.link/redirects-json): vercel.json used private `statusCode` alongside `permanent`. Removed `statusCode`; path aliases are relative so preview does not bounce to production www.
2026-09-04 — Hub visibility: homepage/category/special templates only link indexable pages; stub-only categories stay out of the sitemap; shared hub nav (Home/Signatures/Explore/Metals/Microbes/Diseases). No thin pages invented.
2026-09-06 — Concept coverage: added the six-source [[urea]] article; contextually linked urea, urease, hydrogenase, histidine, nickel transporters, and tight junctions from [[helicobacter-pylori]]; added a deterministic reviewed create-page/backfill/evidence-hold queue. Next create-page candidates are ammonia, catalase, NLRP3 inflammasome, and CagA; bicarbonate remains on evidence hold.
2026-09-07 — Concept coverage Batch 2: added the four-source [[ammonia]] article and contextually linked its first meaningful occurrence from [[urea]], [[urease]], [[helicobacter-pylori]], [[proteus-mirabilis]], and [[ureaplasma]]. The reviewed program now tracks Ammonia as an existing-page backfill job while preserving the remaining corpus-wide link debt.
2026-09-07 — Concept coverage Batch 3: added the six-source [[catalase]] article and contextually linked its first meaningful occurrence from [[oxidative-stress]], [[streptococcus-mutans]], [[metal-dependent-virulence]], [[iron]], and [[aerococcus]]. The page distinguishes the enzyme reaction from whole-network peroxide defense and connects catalase biology to heme iron, microbial competition, virulence, regulation, and metal mis-metallation.
2026-09-07 — Concept coverage Batch 4: added the seven-source [[nlrp3-inflammasome]] article and contextually linked its first meaningful occurrence from 14 high-confidence articles spanning dysbiosis, metal toxicity, gut-barrier biology, cardiovascular and renal disease, thyroid autoimmunity, and neuroinflammation. Seven lower-confidence or more speculative mentions remain queued for later review rather than being linked automatically.
2026-09-07 — Concept coverage Batch 5: added the six-source [[caga]] article and contextually linked its first meaningful occurrence from nine high-confidence articles spanning H. pylori biology, gastric disease, nickel metabolism, hydrogenase, transport, and virulence. The page separates direct gastric mechanistic evidence from weaker GERD, pancreatic-cancer, and thyroid associations; tangential amyloid-beta and glyoxalase mentions remain queued for later evidence review.
2026-09-07 — Concept coverage Batch 6: added the seven-source [[interleukin-22]] article and contextually linked its first meaningful occurrence from 17 articles spanning microbial indoles, AhR and SCFA signaling, mucosal barrier defense, cytokine balance, mycobiome, infant biology, diet, and organism-specific contexts. The page preserves IL-22's context-dependent protective and inflammatory roles and includes null human evidence; one Clostridium symbiosum sentence remains queued because it misattributes IL-22 production to colonocytes.
2026-09-07 — Concept coverage Batch 7: completed a corpus-wide Urease backlink review by adding 59 contextual first-occurrence links across pathogen, metal, disease, environmental, renal, neurological, and microbial-ecology articles. Urease now has meaningful links in 73 of 74 relevant public articles (99% coverage); repeated and Connections-only links were removed where necessary to avoid overlinking. The separate Nickel-Urease page is held for canonical identity consolidation because it describes the same enzyme and cannot responsibly be counted as an ordinary backlink.
2026-09-07 — Concept coverage Batch 8: completed corpus-wide Tight junctions contextual coverage by adding 99 reviewed first-occurrence links across barrier biology, metals, metabolites, diseases, fungi, and microbes. All 102 relevant public articles now link to the existing six-source concept page (100% coverage); later repetitions remain plain text to avoid overlinking, and the planner records the explicit promoted target set for reversibility.
2026-09-07 — Concept coverage Batch 9: completed a corpus-wide Hydrogenase backlink review by adding 41 contextual first-occurrence links across pathogen, metal, disease, chelation, archaeal, and microbial-ecology articles. Hydrogenase now has meaningful links in 51 of 52 relevant articles (98% coverage); later repetitions remain plain text to avoid overlinking. The separate NiFe-Hydrogenase page is held for canonical identity consolidation because it substantially overlaps the broad enzyme page and cannot responsibly be counted as an ordinary backlink.
2026-09-07 — Concept coverage Batch 10: completed corpus-wide Ammonia contextual coverage by adding 32 reviewed first-occurrence links across microbial metabolism, urease-driven pH change, gastric and urinary virulence, renal disease, neurotoxicity, fermentation, biofilms, and metal ecology. All 37 qualifying public entity and concept articles now link to the four-source Ammonia page (100% planner coverage); later repetitions remain plain text to avoid overlinking, and the promoted target set is recorded for reversibility.
2026-09-07 — Concept coverage Batch 11: completed corpus-wide Histidine contextual coverage by adding 26 reviewed first-occurrence links across metal coordination, nickel storage and transport, urease and hydrogenase maturation, histamine production, innate immunity, oxidative defense, neurotoxicity, metalloproteases, and metabolomics. All 29 qualifying public entity and concept articles now link to the three-source Histidine page (100% planner coverage); later repetitions remain plain text to avoid overlinking, and the promoted target set is recorded for reversibility.
2026-09-07 — Concept coverage Batch 12: completed corpus-wide Dysbiosis contextual coverage by adding 243 reviewed first-occurrence links across microbial ecology, disease, host barriers, metabolism, immune signaling, toxic metals, neurobiology, reproductive health, and interventions. All 326 qualifying public entity and concept articles now link to the fourteen-source Dysbiosis page (100% semantic coverage); 95 legacy overlinked articles were normalized to one contextual link, and the NiFe-Hydrogenase phrase “metal dysbiosis” remains intentionally unlinked because it denotes metal dyshomeostasis rather than microbial-community dysbiosis.
2026-09-07 — Concept coverage Batch 13: strengthened the thirteen-source [[metallomics]] article to distinguish the metallome from its measurement, separate total concentration from speciation, spatial, isotope, and metal-binding-molecule layers, and state validation, clinical, and intervention limits. Added 18 reviewed first-occurrence links from the highest-leverage disease, microbial, immune, metabolic, and biomarker contexts; remaining lower-leverage mentions stay queued for later reviewed batches rather than being linked mechanically.
2026-09-07 — Concept coverage Batch 14: strengthened the twelve-source [[neuroinflammation]] article to distinguish CNS immune responses from systemic inflammation, isolated glial activation, and neurodegeneration; replaced binary M1/M2 framing with a state-spectrum account; and separated direct CNS evidence, peripheral proxies, preclinical mechanisms, and intervention limits. Added 18 reviewed contextual links across high-leverage neurological, microbial, barrier, metal, and metabolic articles, raising planner coverage from 23% to 42%; 54 lower-confidence or lower-leverage contexts remain queued, and the offline audit recorded 286 legacy broken file/target pairs outside this batch for later repair.
2026-09-07 — Concept coverage Batch 15: strengthened the nine-source [[tlr4]] article to distinguish variable LPS agonism or antagonism, receptor expression from causal pathway evidence, direct human nickel sensing from downstream metal-associated signaling, and preclinical mechanisms from clinical claims. Added 24 reviewed first-occurrence links across the planner's highest-leverage microbial, barrier, inflammatory, neurological, renal, metabolic, and metal contexts, raising TLR4 planner coverage from 11% to 42%; 44 lower-context mentions remain queued for later review rather than being linked mechanically. Corrected the link-health audit so generated reports no longer ingest their own quoted broken-link examples, and repaired five pre-existing broken references in the reviewed NEC and nickel pages; two consecutive runs now produce the same checksum and a stable 235-file/target legacy backlog.
