...
A landmark perspective covering the molecular mechanisms by which **[[nickel]]**, **[[arsenic]]**, and **[[chromium]]** cause or promote cancer. Key theme: these metals operate through **distinct but overlapping** mechanisms — nickel primarily through [[epigenetic-modifications]] and [[hypoxic-signaling]], arsenic through cellular proliferation and epigenetic changes, and chromium through direct [[DNA-damage]].

## Nickel

### Human Exposure and Carcinogenicity
- Ni(II) is a toxic and carcinogenic metal used in alloys, coins, jewelry, stainless steel, plating, and manufacturing.
- Occupational exposure linked to lung and nasal cavity cancers.
- Nickel subsulfide (Ni₃S₂) is the most potent carcinogenic form; water-soluble nickel compounds are weaker but still active.
- **Epidemiological risk was substantially higher than previously thought**, leading to major revisions of federal standards.
...
### Ni(II) as a Cocarcinogen
- Nickel **enhances UV-induced carcinogenesis** in mice.
- Mechanism: inhibition of nucleotide excision repair (NER) and possibly base excision repair.
- Ascorbate depletion by nickel impairs the function of repair enzymes.
- Dietary chromium and nickel together enhance UV carcinogenesis in hairless mice.

## Arsenic

### Human Exposure and Carcinogenicity
- Environmental exposure through contaminated drinking water (affects millions worldwide).
- Causes cancers of skin, lung, bladder, kidney, liver.
- **One of the few arsenic carcinogenic animal models**: rat urinary bladder (DMA^V).
- Arsenic metabolites (MMA, DMA) may be more dangerous than inorganic forms.
- Methylation is both detoxification and bioactivation — DMA^III is highly reactive.
...
- Strong cocarcinogenic activity with UV, other mutagens.
- Mechanism: **inhibition of DNA repair** (NER, base excision repair, possibly mismatch repair).
- Low arsenic + UV produces significantly more skin tumors in mice.

## Chromium

### Human Exposure and Carcinogenicity
- **Cr(VI)** is the carcinogenic form; Cr(III) is an essential nutrient (debated).
- Primary exposure: occupational (chromate production, stainless steel welding, chrome plating).
- Causes primarily **lung cancer** (squamous cell carcinoma in chromate workers).
- Also present in contaminated drinking water (~30% of US supplies exceed proposed limits).
- Recent epidemiological risk revision: carcinogenic risks associated with chromate and arsenic exposures were **substantially higher than previously thought**.

### Cr(VI) Metabolism and DNA Damage
- Cr(VI) enters cells via sulfate channels (molecular mimicry of CrO₄²⁻ with SO₄²⁻).
- Massive cellular accumulation: 10-20x outside levels within 3h; 100-fold+ in 24h.
...
- Inhibits **mismatch repair** (MMR) proteins — leading to replication errors escaping correction.
- Paradox: intracellular ascorbate is a very potent stimulator of both Cr(VI) reduction (generating DNA damage) AND genomic instability. But ascorbate is also needed for DNA repair.
- **Selection model**: Cr(VI) at low doses generates mutations; cells with compromised DNA repair survive and accumulate additional mutations → cancer.

### Cr(VI) as a Cocarcinogen
- Well-documented cocarcinogenesis with UV radiation.
- Increases susceptibility to UV-induced skin tumors in drinking water exposure.
- Chromium and nickel together enhance UV carcinogenesis.

## Cross-Cutting Themes

| Feature | Nickel | Arsenic | Chromium |
|---------|--------|---------|----------|
| Primary mechanism | Epigenetic + hypoxic signaling | Proliferation + epigenetic | Direct DNA damage |
| DNA adducts | No (weak/none) | No | Yes (Cr-DNA ternary) |
| Epigenetic effects | Strong (methylation, histone) | Strong (methylation) | Moderate |
| Oxidative stress | Moderate | Debated | At high doses |
| Cocarcinogenesis | Yes (with UV) | Yes (with UV) | Yes (with UV) |
| Ascorbate role | Depleted → impairs repair | Less central | Drives reduction (double-edged) |
| Repair inhibition | NER inhibition | NER, BER inhibition | MMR inhibition |

## Connections

- [[nickel]], [[arsenic]], [[chromium]] — the three metals reviewed
- [[epigenetic-modifications]] — central to Ni and As mechanisms
- [[hypoxic-signaling]] — unique to nickel
- [[DNA-damage]] — central to chromium
- [[oxidative-stress]] — implicated in all three
- [[metal-carcinogenesis]] — the overarching concept
- Relates to [[liu-2025-cardiometabolic-nickel]] for nickel's non-cancer toxic effects
