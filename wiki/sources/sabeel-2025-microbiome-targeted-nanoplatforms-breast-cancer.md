...
- **Study type**: Comprehensive review (37 pages, 420+ references)
- **Tumor-associated microbiota by BC subtype**: TNBC (Bacillus, Mucor, Toxocara); ER+/PR+/HER2- (Klebsiella, Stenotrophomonas); Triple-positive (Orientia, Klebsiella, Fusobacterium) -- microbial profiles correlate with prognosis
- **Nanoplatform categories**: Lipid-based NPs, polymeric NPs, metallic NPs, bacterial membrane-coated NPs, multifunctional nanosystems
- **Preclinical drug delivery**: Summary of 30+ in vitro/in vivo studies (Table 2) including PTX SLNs, Ribociclib NLCs, Quercetin micelles, DOX liposomes
- **Microbiome modulation of immunotherapy**: Bifidobacterium enhances anti-PD-1 efficacy; L. reuteri administration enhanced NK cell activity and IL-27 production, reducing metastasis
- **Drug resistance via microbiome**: F. nucleatum promotes chemoresistance through autophagy; certain bacteria metabolize drugs reducing efficacy
- **FMT in cancer**: Referenced as potentially efficacious in HER2+ BC via antitumor immunity modulation; clinical application in MBC remains largely unexplored
