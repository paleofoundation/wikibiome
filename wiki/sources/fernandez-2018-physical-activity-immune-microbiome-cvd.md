...
- Exercise-mediated changes in gut microbiome can induce specific phenotypes: transplanting microbiome from exercised or non-exercised mice to germ-free mice produced distinct metabolome and colonic inflammation changes
- Gut microbiome alterations from exercise were dependent on obesity status: SCFAs increased in lean but not obese participants, and changes disappeared once exercise ceased

# Methods/Findings

- **Study type**: Mini review of the intersection of PA, immune system, and microbiome in CVD
- **Key cytokine table**: Comprehensive summary of cytokines (CCL2/MCP-1, CCL5, CX3CL1, IFN-gamma, IL-1beta, IL-2, IL-4, IL-5, IL-6, IL-10, TGF-beta, TNF-alpha) with their CVD effects and PA regulation
- **Immune cells and PA**: NK cells increase in number and cytotoxic activity with exercise; neutrophils become dysfunctional with aging but PA promotes migration in older adults; Tregs display higher frequencies in athletes
- **Microbiome and PA**: Professional rugby athletes had lower inflammatory status and enriched bacterial diversity with notable enrichment in Ruminococcaceae, *Succinivibrionaceae*, and *Akkermansia*
