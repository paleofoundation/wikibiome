...
- Exposure to biocides (disinfectants, antiseptics, preservatives) and heavy metals (especially [[copper]] and [[zinc]] used as livestock growth promoters) can induce or select for bacterial adaptations resulting in decreased susceptibility to antibiotics
- Co-selection operates through both cross-resistance (shared cellular mechanisms, especially efflux pumps) and co-resistance (genetic linkage of resistance determinants on mobile elements)
- Some co-selective adaptations have adverse effects on bacterial fitness in the absence of continued selective pressure, but compensatory mutations can restore fitness and make resistance effectively permanent
- The livestock food chain is an area of particular scrutiny because zoonotic bacteria (*Salmonella*, MRSA, *Campylobacter*) can transmit resistance to humans via food
...
This is the most comprehensive review connecting [[co-selection]] to food safety and the livestock production system. For the wiki, it provides the critical link between environmental metal contamination (from agriculture) and human health outcomes through the food chain. The review's detailed treatment of biocides as a third category of co-selective agents (alongside metals and antibiotics) expands the framework beyond the metal-antibiotic binary. The finding that copper liberation from bacterial cell envelopes under biocide stress activates the MarRAB regulon -- directly linking biocide exposure to broad-spectrum antibiotic resistance via a metal intermediate -- is a remarkable mechanistic insight that connects environmental chemistry to clinical resistance.

# Connections

- [[co-selection]] -- most comprehensive review of co-selection mechanisms with focus on food chain relevance
- [[antimicrobial-resistance]] -- biocides, metals, and antibiotics form a triple-threat co-selection nexus in agriculture
- [[copper]] -- Cu as livestock growth promoter; 90% of in-feed Cu excreted in feces; Cu liberation activates MarRAB regulon
