...
created: 2026-04-09
updated: 2026-04-09
authors: [Zi-Yi Han, Zhuang-Jiong Fu, Yu-Zhang Wang, Cheng Zhang, Qi-Wen Chen, Jia-Xin An, Xian-Zheng Zhang]
...
- **Biomaterial design**: LGG coated with chitosan, then Ga3+-EGCG polyphenol network; Ga3+ disrupts bacterial iron metabolism; EGCG provides additional polyphenol activity
- **Selective antimicrobial activity**: Ga3+ showed strong activity against *E. coli*, *S. aureus*, *B. subtilis* but not LGG; LGG@Ga-poly selectively eliminated *E. coli* and *F. nucleatum*
- **Intratumor microbiota modulation**: FISH confirmed reduced Proteobacteria in orthotopic tumors; LPS concentration significantly decreased (P < 0.0001)
- **Immune effects**: Increased dendritic cells (P = 0.002), M1 macrophages (P = 0.0014), CD3+CD4+ T cells (P = 0.0073), CD3+CD8+ T cells (P = 0.0001); decreased M2 macrophages (P = 0.0089) and MDSCs (P = 0.0003)
- **Checkpoint blockade synergy**: LGG@Ga-poly combined with anti-PD-L1 significantly inhibited both subcutaneous and orthotopic PDAC tumor growth
- **Penetration**: FITC-labeled LGG@Ga-poly penetrated into PDAC 3D cell spheres pre-infected with *E. coli*
