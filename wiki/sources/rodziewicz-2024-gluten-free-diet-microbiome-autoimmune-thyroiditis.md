...
- **Population**: 31 women (aged 20-50) with AIT diagnosed by increased anti-TPO and/or anti-Tg antibodies, stabilized thyroid function, normal BMI (18.5-24.9 kg/m2), enrolled in Pomeranian Voivodeship, Poland
- **Design**: 8-week normocaloric GFD for all participants; after first 4 weeks, randomized to receive gluten capsules (2g/day, n=16) or rice starch placebo (n=15) for remaining 4 weeks
- **Sequencing**: 16S rRNA sequencing (V3-V4 region) using MiSeq Illumina; QIIME 2 with Silva 138 database; DADA2 for ASV analysis
- **Microbiome results at 4 weeks GFD (T0 to T1)**: Desulfobacterota increased (p=0.021), Proteobacteria increased (p=0.015), Actinobacteriota decreased (p=0.038), Coriobacteriaceae decreased (p=0.003), Bifidobacterium decreased (p=0.011), Prevotella increased (p=0.044), Parasutterella increased (p=0.008)
- **Gluten vs placebo (T1 to T2)**: Significant effect observed only in placebo group (increased Actinobacteriota and Bacteroidota); no significant changes in gluten group
- **Blood parameters**: No significant differences in TSH, FT4, FT3, anti-TPO, anti-Tg, CRP, ESR, or fasting glucose between groups at any time point; thyroid peroxidase antibody levels showed significant difference between groups only at placebo allocation
- **Celiac screening**: None of the 31 participants had elevated celiac markers (EmA, tTG IgA, AGA)
