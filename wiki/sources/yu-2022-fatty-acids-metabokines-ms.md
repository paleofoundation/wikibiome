...
created: 2026-04-09
updated: 2026-04-09
authors: [Yu H, Bai S, Hao Y, Guan Y]
...
- **Design**: Comprehensive review from Shanghai Jiao Tong University, covering molecular to systematic levels of FA involvement in MS
- **FA classification**: SCFAs (C1-C5), MCFAs (C6-C12), LCFAs (C16-C22); each class has distinct CNS entry mechanisms (SCFAs/MCFAs cross BBB passively; PUFAs rely on transcytosis)
- **Key immune mechanisms**: SCFAs activate GPR41/43 on immune cells; butyrate promotes Treg via HDAC inhibition and Foxp3 expression; propionate promotes intestinal Treg via GPR43; MCFAs activate GPR40/120 on immunocytes; LCFAs inhibit proinflammatory response via macrophage M2 polarization
- **EAE therapeutic evidence** (Table 2): Valproic acid (250-500 mg/kg/day) preventive and therapeutic in multiple EAE models; propionic acid (150 mM, 200 ul) diet promotes intestinal Treg via p38/MAPK inhibition; lauric acid diet promotes Th17 (detrimental)
- **Remyelination potential**: FAs are essential components of oligodendrocyte membranes; PUFA supplementation stimulates oligodendroglia differentiation; CNS FA composition changes during demyelination
