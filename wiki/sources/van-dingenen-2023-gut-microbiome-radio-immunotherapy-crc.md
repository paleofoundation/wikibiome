...
- **Study type**: Comprehensive review focusing on CRC-specific radiotherapy and immunotherapy
- **Dysbiosis mechanisms in CRC**: (1) Pathogenic bacteria/toxic products, (2) inflammation, (3) oxidative stress, (4) altered metabolites (reduced SCFAs, polyphenols, vitamin D; increased bile acids, TMA, polyamines), (5) biofilm formation
- **Radiotherapy-microbiome**: Comprehensive table of radiation-induced bacterial changes across cancer types; pelvic radiation decreases Lactobacillus, Bifidobacterium, and Firmicutes while increasing Clostridium, Fusobacterium, and Proteobacteria
- **ICB-microbiome**: Anti-CTLA-4 efficacy depends on different bacteriophage types; anti-PD-1 efficacy linked to Bifidobacterium, Akkermansia; Roseburia associated with better radiation response in prostate cancer
- **Microbiome as CRC biomarker**: dMMR patients have higher alpha diversity; enrichment of Fusobacteriota, Firmicutes, Verrucomicrobia; pMMR patients show more Proteobacteria
- **FMT in BC context**: Referenced L. reuteri administration reducing tumors in mouse models; FMT from trastuzumab-responsive mice enhanced HER2+ BC antitumor immunity
