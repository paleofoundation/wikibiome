...
- **Study type**: Study protocol for a 4-arm parallel RCT (BRIDGE-CRC)
- **Population**: 192 AA/B adults aged 45-75 with obesity (BMI 30-50), randomized to: (1) Med-A (Mediterranean diet alone), (2) WL-A (weight loss alone), (3) WL-Med (weight loss + Mediterranean diet), (4) TDC (typical diet control)
- **Duration**: 6 months intervention; data collection at baseline, month 3, month 6
- **Primary outcomes**: Total circulating and fecal bile acids, taurine-conjugated bile acids, and DCA
- **Secondary outcomes**: Body weight/composition, dietary change, physical activity, metabolic risk, circulating cytokines (IL-6, TNFa), gut microbial community structure/composition, fecal SCFAs (butyrate, acetate, propionate), exfoliated intestinal cell gene expression
- **Specific microbiome measures**: 16S rRNA composition, predicted metabolic pathways, microbial network analysis; quantitative PCR for B. wadsworthia-specific dsrA, Desulfovibrio 16S, BA 7alpha-dehydratase from C. scindens, butyryl-CoA transferase (BcoA)
- **MedDiet intervention**: 24 weekly one-on-one sessions, food box deliveries (9 total), MEPA-III screener for adherence; 25-35 g/day fiber, ~35% total fat (~20% MUFA), olive oil as main fat source
- **Exclusion criteria**: Prebiotics, probiotics, synbiotics, dietary fiber supplements, laxatives within 4 weeks; oral/IV antibiotics within 3 months
