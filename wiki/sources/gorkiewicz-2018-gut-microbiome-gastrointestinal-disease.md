...
created: 2026-04-09
updated: 2026-04-09
authors: [Gorkiewicz G, Moschen A]
...
- **Study type**: Invited annual review
- **Scope**: Spatial organization of GI microbiome, inflammatory and neoplastic diseases of esophagus, stomach, small and large intestines, and approaches to restore microbiome
- **Key concepts**: Biogeography of GI microbiome, mucus layer architecture by segment, immune tolerance induction, driver-passenger model of bacterial carcinogenesis
- **Techniques highlighted**: Carnoy's fixative for mucus preservation, FISH for in situ microbiome visualization, 16S rRNA sequencing, metagenomics

## Connections

- Spatial microbiome organization provides framework for understanding esophageal findings in [[deshpande-2018-esophageal-microbiome-signatures-host-genetics]]
- Upper GI acid-tolerant taxa align with community types in GERD studies
- FMT as therapeutic approach connects to FMT subdirectory studies
- Mucus layer architecture relates to barrier dysfunction in [[chen-2024-esophageal-dysbiosis-tlr2-barrier-integrity-gerd]]
- SCFA metabolism connects to functional pathway analysis in esophageal community types
