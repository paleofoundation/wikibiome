...
- Dietary exposure to heavy metals (Hg, Cd, As, Pb, Cr, Zn) plays a significant role in the development and progression of neurodegenerative diseases (NDDs)
- These metals disrupt essential cellular and molecular functions including oxidative stress induction and mitochondrial function impairment
- Heavy metals disrupt cellular signaling via mRNA splicing, ubiquitin-proteasome system (UPS), electron transport chain (ETC), and ROS production
- Diet is the main exposure source for non-professionally exposed populations
- Shared pathological pathways across HD, PD, ALS, and AD highlight the systemic impact of heavy metals
