...
created: 2026-04-09
updated: 2026-04-09
authors: [Niehoff NM, O'Brien KM, Keil AP, Levine KE, Liyanapatirana C, Haines LG, Waidyanatha S, Weinberg CR, White AJ]
...
- Racial/ethnic differences in metal exposure and breast cancer associations were observed but inconsistent

## Methods/Findings

- **Study design**: Case-cohort nested within the Sister Study (enrolled 2003-2009, followed through September 2017)
- **Population**: 50,884 women in the US and Puerto Rico aged 35-74 with a sister who had breast cancer; 1,495 cases and 1,605 subcohort members in the race/ethnicity-stratified sample
- **Exposure assessment**: 15 metals measured in toenails at enrollment using ICP-MS (aluminum, antimony, arsenic, cadmium, chromium, cobalt, copper, iron, lead, manganese, molybdenum, nickel, selenium, tin, zinc)
- **Follow-up**: Average 7.5 years; mean age at enrollment ~55 years
- **Statistical methods**: Cox regression with robust variance; quantile g-computation for metal mixtures; adjusted for age, education, race/ethnicity, BMI, smoking, parity/breastfeeding
- **Key null findings**: Cadmium (HR per IQR = 0.99, 95% CI: 0.97, 1.02), nickel (T3 vs T1: HR = 1.04, 95% CI: 0.86, 1.26), copper (T3 vs T1: HR = 1.01, 95% CI: 0.83, 1.23), lead (T3 vs T1: HR = 1.04, 95% CI: 0.86, 1.26) all showed no significant associations
- **ER-status differences**: Molybdenum showed stronger inverse association for ER-negative cancer (HR = 0.57, 95% CI: 0.38, 0.88); arsenic inversely associated with ductal carcinoma in situ but not invasive cancer
- **Race/ethnicity differences**: Antimony inversely associated in non-Hispanic Black women; zinc showed dose-related positive association in non-Hispanic Black women (T3: HR = 1.38, 95% CI: 0.94, 2.03)
- **Mixture analysis**: Quantile g-computation showed no joint association of all 15 metals with breast cancer
