...
created: 2026-04-09
updated: 2026-04-09
authors: [Sarandi E, Tsoukalas D, Rudofsky G, Liapi C, Paramera E, Papakonstantinou E, Krasagakis SK, Tsatsakis A]
...
- Artificial neural network analysis achieved AUC of 0.8 using methylmalonic acid, SFA, and palmitoleic/palmitic ratio as predictors
- Debiased sparse partial correlation network analysis revealed palmitic acid (C16:0), alpha-linolenic acid (C18:3n3), and dihomo-gamma linolenic acid (C20:3n6) as most important network hubs in HT

## Methods/Findings

- **Study type**: Case-control study from METHAP clinical trial (NCT04693936)
...
- Metabolomic changes complement microbiome findings in [[gong-2024-iodine-gut-microbiota-hashimotos]]
- Micronutrient bioavailability connects to [[li-2025-trace-elements-autoimmune-thyroid-disease]]
- Mitochondrial dysfunction and [[oxidative-stress]] link to [[khan-2020-environmental-exposures-autoimmune-gut-microbiome]]
- Gut microbial metabolite markers connect to [[liu-2024-causal-gut-microbiota-metabolites-hypothyroidism-mendelian]]
- Fatty acid metabolism disruption relevant to [[luo-2025-serum-metabolomics-hashimotos-tgab-tpoab]]
- Microbiome-mediated metabolite changes align with [[zhu-2024-intestinal-microbiota-gut-thyroid-axis-hashimotos]]
