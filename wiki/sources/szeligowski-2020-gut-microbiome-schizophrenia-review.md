...
created: 2026-04-09
updated: 2026-04-09
authors: [Szeligowski T, Yun AL, Lennox BR, Burnet PWJ]
...
- **Study type**: Mini review of existing literature on [[dysbiosis]] in schizophrenia and clinical applications
- **Dysbiosis evidence**: Summarized 8 case-control studies (Table 1) comparing gut microbiome composition between schizophrenia patients and healthy controls using 16S rRNA sequencing
- **Consistent findings across studies**: Enrichment of Proteobacteria, Lactobacillaceae, and Veillonellaceae in schizophrenia; depletion of Lachnospiraceae, Ruminococcaceae, and butyrate producers
- **Inconsistent findings**: Microbial richness/diversity showed no significant differences in most studies; specific taxa enriched in schizophrenia varied across studies
- **Prebiotics**: Galactooligosaccharides (B-GOS) reduced cortisol awakening response and increased attentional vigilance to positive stimuli in healthy volunteers; potential to improve cognition in schizophrenia
- **Probiotics**: Severance et al. (2017) conducted a pilot RCT showing reduced yeast infections but no significant psychiatric symptom improvement

## Connections

- [[gut-brain-axis]] -- bidirectional communication via vagus nerve, immune signaling, tryptophan metabolites, and SCFAs
- [[neuroinflammation]] -- inflammatory cytokines elevated in schizophrenia may originate partly from gut bacterial translocation
- [[tryptophan-metabolism]] -- kynurenine pathway dysregulation links microbiome to NMDA receptor hypofunction
- [[dysbiosis]] -- gut permeability and bacterial translocation markers elevated in schizophrenia
- [[immune-balance]] -- Th1/Th2 and Th17/Treg imbalance implicated
