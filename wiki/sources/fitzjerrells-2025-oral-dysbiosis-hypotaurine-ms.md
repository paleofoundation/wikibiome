...
created: 2026-04-09
updated: 2026-04-09
authors: [Rachel L. Fitzjerrells, Leeann Aguilar Meza, Meeta Yadav, Heena Olaide, Jemmie Hoang, Mishelle Paullus, Catherine Cherwin, Tracey A. Cho, Grant Brown, Sukirth M. Ganesan, Ashutosh K. Mangalam]
...
- **Study design**: Case-control; 50 pwRRMS (University of Iowa Neurology Clinic) and 50 HCs; saliva samples
- **Methods**: Shotgun metagenomic sequencing (BGI); untargeted metabolomics (Metabolon); OPLS-DA, PCA, random forest classifiers
- **Demographics**: Never/quit smoking >= 10 years; no antibiotics in 3 months
- **Microbiome results**: 102 species differentially abundant at individual level; 96 bacteria (46 enriched, 50 lower), 5 viruses (2 enriched, 3 lower), 1 fungal species enriched in pwRRMS
- **Topic modeling**: 33 topics identified; 5 microbial communities more often in HCs than pwRRMS (Streptococcus, Veillonella, Actinomyces dominated)
- **Metabolome results**: 14 metabolites significantly altered; lower in pwRRMS: hypotaurine, lauryl sulfate, fucose, 3-hydroxyisobutyrate, 2,3-dihydroxyisovalerate; higher: ribose-1-phosphate, nicotinamide, N-acetylglucosamine, N-acetyl-isoputreanine, inosine, guanosine, guanine, cytidine, 2-hydroxyisobutyrate
- **Microbiome-metabolome correlations**: Over 20 times more correlations in pwRRMS than HC (Fig 8), suggesting disrupted co-metabolic network
- **Limitations**: Cross-sectional; periodontitis not assessed; single-center; causal relationships not established

## Connections

- [[multiple-sclerosis]] -- oral microbiome and metabolome as novel diagnostic window
- -- depletion of early Gram-positive colonizers and enrichment of Gram-negative pathogens in MS
- -- depleted salivary metabolite as potential MS biomarker; taurine pathway linked to myelin maintenance
