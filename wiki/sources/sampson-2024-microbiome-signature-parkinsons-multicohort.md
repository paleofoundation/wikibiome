---
title: "Sampson 2024 -- A Microbiome Signature of Parkinson's Disease"
type: source
created: 2026-04-09
updated: 2026-04-09
...
- A core set of microbial taxa consistently distinguishes PD from controls across multiple cohorts
- The signature includes depleted SCFA producers and enriched opportunistic pathogens
- Machine learning classifiers trained on one cohort generalize to independent populations
- The signature is partially independent of PD medications, age, and BMI
- Functional pathway enrichment reveals conserved metabolic disruptions in PD microbiomes
- The multicohort approach increases confidence in microbiome-based diagnostics for PD
...
- Cross-sectional multi-cohort design with inherent heterogeneity
- Different sequencing platforms across cohorts require harmonization
- Core signature may miss population-specific features
- Clinical utility requires prospective validation trials
