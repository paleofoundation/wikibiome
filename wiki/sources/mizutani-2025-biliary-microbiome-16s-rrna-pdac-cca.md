...
created: 2026-04-09
updated: 2026-04-09
authors: [Hiroki Mizutani, Shunsuke Fukui, Kazuki Oosuka, Kohei Ikeda, Mayu Kobayashi, Yasuaki Shimada, Yuuichi Nakazawa, Yuuki Nishiura, Daisuke Suga, Isao Moritani, Yutaka Yamanaka, Hidekazu Inoue, Hayato Nakagawa, Kaoru Dohi, Hiroyuki Kaiju, Kei Takaba, Hideo Wada, Katsuya Shiraki]
...
- **Study design**: Bile samples from 40 CDL, 17 CCA, and 15 PDAC patients analyzed by bacterial 16S rRNA and fungal ITS sequencing
- **Alpha diversity**: No significant differences in Chao1 between groups; PDAC group had significantly lower DNA yields (p < 0.01)
- **Beta diversity**: Significant Bray-Curtis clustering differences between CCA vs CDL (p < 0.01) and PDAC vs CDL (p < 0.05)
- **Bacterial composition**: Gammaproteobacteria and Bacilli predominant (>60%); at order level, Enterobacteriales and Lactobacillales most common
- **LDA analysis**: PDAC enriched in Alphaproteobacteria, *Neisseria*, *Sphingomonas*, *Caulobacter*; CDL enriched in Gammaproteobacteria, *Klebsiella*, *Escherichia*, *Clostridium*
- **Fungal mycobiome**: *Agaricomycetes* predominant; CCA and PDAC showed lower *Agaricomycetes* and higher *Saccharomycetes* than CDL; no significant bacterial-fungal correlations
- **Functional prediction**: PICRUSt2 revealed 38 enzymes differentially expressed between CCA and CDL, 48 between PDAC and CDL
