...
- Metal ions including Fe, Cu, Zn, Al, Pb, Cd, and Hg play significant roles in AD pathogenesis through multiple mechanisms
- Metals promote amyloid-beta aggregation, tau hyperphosphorylation, oxidative stress, and neuroinflammation
- Both essential metal dyshomeostasis (Fe, Cu, Zn) and toxic metal exposure (Al, Pb, Cd, Hg) contribute to AD
- Metal chelation therapy represents a potential therapeutic approach but faces challenges including selectivity and side effects
- The interplay between multiple metals creates synergistic neurotoxic effects that are poorly understood
