...
- **Scope**: Impact of viral infections (EBV, HHV-6, HSV, HPV, HCV, HIV, parvovirus B19, SARS-CoV-2) on thyroid function and thyroid cancer
- **Table 2**: Comprehensive summary of key viral functions (direct cell entry, cytokine modulation, thyroid autoantibody, thyroid dysfunction) and relationships to AITD and TC
- **Mechanism figure**: EBV, HHV-6, HSV promote thyroid cell apoptosis, cytokine release (IL-1, IL-6, VEGF), inflammation, autoantibody production, oncogenic expression leading to AITD and TC
- **HCV-thyroid link**: CHC patients have higher T3, T4, anti-TPO, anti-Tg, and anti-thyroid antibodies
- **B19 evidence**: CXCL10 serum levels higher in B19V-positive Hashimoto's patients
