...
created: 2026-04-09
updated: 2026-04-09
authors: [Li S, Song J, Ke P, Kong L, Lei B, Zhou J, Huang Y, Li H, Li G, Chen J, Xiang Z, Ning F, Wu K]
...
- **Population**: 38 schizophrenia patients and 38 demographically matched normal controls
- **Methods**: 16S rRNA gene sequencing from fecal samples; structural MRI (sMRI) and resting-state fMRI (rs-fMRI)
- **Microbiome**: No significant between-group difference in alpha diversity; significant difference in beta diversity (Bray-Curtis, pseudo-F=1.71, p=0.019)
- **Dominant genera in SZ**: Faecalibacterium, Megamonas, Ruminococcus, Akkermansia
- **Brain-microbiome link**: Roseburia depletion correlated with reduced ReHo in temporal and occipital regions

## Connections

- [[gut-brain-axis]] -- first direct evidence linking gut microbiome composition to brain structural and functional measures in schizophrenia
- [[dysbiosis]] -- depletion of butyrate-producing Roseburia and Ruminococcus
