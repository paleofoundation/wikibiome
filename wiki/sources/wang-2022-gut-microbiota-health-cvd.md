...
- Aromatic amino acid metabolites including tryptophan, indole, and phenolic compounds are associated with cardiovascular risk; excessive indoxyl sulfate causes cardiomyocyte damage and increases thrombosis formation

# Methods/Findings

- **Study type**: Comprehensive review (50 pages) of gut microbiota roles in health and CVD
- **Coverage**: Normal gut physiology, intestinal barrier function, immune regulation (TLR, NLR, NLRP3 pathways), metabolite pathways (SCFAs, bile acids, TMAO, amino acids), neuroendocrine system interactions
- **Key figure**: Metabolic pathway diagram showing glucose/lipid/protein metabolism branches through gut microbiota to downstream signaling (GPR41/43, FXR/TGR5, NF-kB, mTORC1)
- **Gut barrier mechanisms**: Tight junctions, mucus layer, butyrate-mediated epithelial nutrition, Paneth cell antimicrobial peptides, IgA production
