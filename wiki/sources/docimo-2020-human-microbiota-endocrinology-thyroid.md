...
created: 2026-04-09
updated: 2026-04-09
authors: [Docimo G, Cangiano A, Romano RM, Pignatelli MF, Offi C, Paglionico VA, Galdiero M, Donnarumma G, Nigro V, Esposito D, Rotondi M, Candela G, Pasquali D]
...
- **Scope**: Characterizes microbiota in AITD, evaluates dysbiosis impact on treatment/prognosis, and examines microbiome in thyroid cancer
- **HT findings**: Increased Bacteroides in some studies; Proteobacteria, Actinobacteria, Enterobacteriaceae, and Alcaligenaceae increased compared to controls
- **GD findings**: Decreased F/B ratio; Prevotella, Lactobacillus, Bifidobacterium reduced
- **Cancer findings**: Large quantitative and qualitative changes in intestinal microbial flora in thyroid cancer patients with increased Clostridiaceae, Neisseria, and Streptococcus
- **Probiotic potential**: Lactobacillus reuteri shown in mice to modulate Tregs and suppress autoimmune thyroiditis

## Connections

- Mineral absorption effects link to [[kravchenko-2023-thyroid-hormones-minerals-AITD]] and [[brylinski-2025-trace-elements-thyroid-diseases]]
- Lactobacillus pattern in HT connects to [[harbi-2024-lactobacillus-candida-thyroid-disorders]]
- Methimazole-microbiome interaction expanded in [[huo-2021-bifidobacterium-longum-methimazole-graves]]
- Thyroid cancer microbiome links to [[kun-2023-microbiota-thyroid-cancer]] and [[wang-2025-gut-microbiome-thyroid-cancer-review]]
