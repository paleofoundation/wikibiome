...
- The host microbiota resides in multiple body sites (oral, nasal, lung, gut, skin, bladder, vagina) and all may potentially influence [[gut-brain-axis|neuropsychiatric disorders]]
...
- In subjects with mild cognitive impairment (MCI), higher levels of [[haemophilus|Pasterellaceae]] were observed compared to cognitively normal controls, and Pasterellaceae was associated with inflammatory markers in CSF
...
- [[depression]] is a common psychiatric symptom in patients with [[autoimmunity|skin diseases]] including [[autoimmunity|psoriasis]], and skin microbiota alterations may influence mood through inflammatory pathways

## Methods/Findings

- **Study type**: Expert review
- **Scope**: Comprehensive overview of host microbiome (not just gut) in neuropsychiatric disorders
- **Key body sites reviewed**: Gut (dominant focus), oral cavity, nasal passages, lung, skin, vaginal microbiota
- **Predominant phyla by site**: Mouth (Actinobacteria, Bacteroidetes, Firmicutes, Fusobacteria, Proteobacteria); Intestine (Bacteroidetes, Firmicutes); Vagina (Lactobacillus)
- **Neuropsychiatric conditions**: Depression, schizophrenia, bipolar disorder, autism spectrum disorder, PTSD, Alzheimer's, Parkinson's, multiple sclerosis
- **Gut microbial density**: Ranges from 10^1 (stomach) to 10^12 (colon)
