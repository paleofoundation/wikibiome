...
- **UC mechanisms**: BBR blocks NF-kB pathway (via IkBa enhancement), downregulates IFN-gamma targeted genes (IRF8, IRF1, Ifit1, Ifit3), reduces TNF-alpha, CXCL1, CXCL9; maintains Wnt/beta-catenin for tissue regeneration
- **Macrophage polarization**: BBR targets M1/M2 balance; reduces IL-10 and TGF-beta pathways in macrophage polarization; increases MHC-II and CD40 expression enhancing CTL activity
- **Anti-tumor pathways**: (1) AMPK activation at Thr172 suppresses colon xenograft growth, (2) MAPK/mTOR/p70-S6K inhibition in gastric cancer, (3) Wnt/beta-catenin blockade induces apoptosis in CRC, (4) COX-2 inhibition
- **Gut microbiome effects**: BBR weakens trimethylamine generation by microbiota, reduces cholesterol-induced atherosclerosis; regulates sodium butyrate production; boosts alpha and beta diversity
- **Immunotherapy enhancement**: BBR serves as dopamine D1/D2 receptor antagonist diminishing IL-6, IL-1beta, IFN-gamma; improves PD-1/PD-L1 blockade efficacy
- **Clinical evidence**: Phase I trial showed BBR lowers Geboes Score in UC patients (Chinese cohort)
