...
- **Study type**: Cross-sectional population-based study within the Framingham Heart Study
- **Population**: 1423 participants from FHS Generation 3, OMNI 2, and New Offspring Spouse cohorts (Exam 3, 2016-2019); 55.7% female, mean age 55, average BMI 28 kg/m2
- **Methods**: 16S rRNA gene amplicon sequencing (V4 region); UPARSE pipeline for OTU clustering; MaAsLin2 for association analyses; PICRUSt for functional profiling; correlation networks via ggnet2
- **Disease prevalence**: CVD 4.6%, T2D 9.1%, metabolic syndrome 18%, obesity 30%
- **Key variables**: 13 anthropometric/blood analytes; 27 diagnostic conditions and medications; dietary recall; physical activity questionnaire
- **Metabolic syndrome definition**: 3+ of 5 criteria (abdominal obesity, high triglycerides, low HDL, high BP, high fasting glucose) per NHLBI guidelines
