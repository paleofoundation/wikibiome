...
- **Study type**: Bidirectional two-sample MR with 121 bacterial genera
- **Exposure**: IEU Open GWAS gut microbiota (14,306 individuals, 24 cohorts)
- **Outcomes**: AF (n=1,030,836), CAD (n=547,261), MI (n=395,795), IS (n=211,763), hypertension (n=21,936)
- **Methods**: IVW, MR-Egger, weighted median, simple model, MR-PRESSO, weighted model
- **Forward MR**: 522 SNPs as IVs for 121 genera; no horizontal pleiotropy or heterogeneity detected for significant associations
