...
- 26% of participants taking 1 medication, 21% taking 2+ medications
- Alpha and beta diversity were similar among groups (not significantly different)
- After controlling for covariates, 6 genera (*Saprospiraceae* uncultured, *Bacillus*, *Johnsonella*, *Actinobacillus*, *Stenotrophmonas*, *Mycoplasma*) differed between medication users and non-users
- Thyroid hormones and PPIs were the most common medications
- Relative abundance of 8 genera differed in statin users; 6 genera differed in thyroid hormone users
- No significant changes observed with PPI use alone
- Overall, minimal influence of commonly used medications on oral microbiome diversity
...
- Healthy population without major chronic conditions (explicitly excluded MS)
- Self-reported medication data
- Oral microbiome only, not gut
