...
created: 2026-04-09
updated: 2026-04-09
authors: [Lopez-Botella A, Gomez-Torres MJ, Sanchez R, Todoli-Torro JL, Velasco I, Acien M]
journal: Toxics
year: 2023
...
- Potentially toxic elements (PTEs) found as environmental contaminants have been related to [[endometriosis]]
- A peritoneal endometriosis patient following a lacto-ovo vegetarian diet had significantly elevated [[nickel]], lead, and bismuth levels in her peritoneal fluid (PF) compared to an age-matched healthy control
- The elevated Ni levels (4:1 ratio vs. control) in PF may be attributable to the patient's vegetarian diet, as ovo-lacto-vegetarians consume higher amounts of Ni than people on mixed diets
- The peritoneal fluid is an understudied but important matrix for understanding PTE exposure and endometriosis pathogenesis
- PTEs classified as endocrine-disrupting compounds (EDCs) may contribute to estrogen-dependent disease development

# Methods/Findings

- **Study design**: Case report with age-matched control comparison
- **Case patient**: 22-year-old woman, peritoneal endometriosis + serous cystadenoma, diagnosed via laparoscopy at San Juan University Hospital, Alicante, Spain
...
- **Limitations**: Single case report; cannot establish causation; results are preliminary

# Connections

- [[nickel]] -- significantly elevated (4:1 ratio) in peritoneal fluid of endometriosis patient; may be ingested through vegetable consumption and accumulate in the peritoneal environment
- [[dietary-nickel-exposure]] -- vegetarian diet identified as a plausible route for elevated Ni in peritoneal fluid; high-Ni foods consumed regularly by the patient (nuts, tomatoes, legumes)
- [[oxidative-stress]] -- PTEs can impair oocyte maturation, ovulation, and fertilization via excess ROS production
