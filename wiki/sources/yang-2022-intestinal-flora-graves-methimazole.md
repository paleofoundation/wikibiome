...
created: 2026-04-09
updated: 2026-04-09
authors: [Yang M, Zheng X, Wu Y, Zhang R, Yang Q, Yu Z, Liu J, Zha B, Gong Q, Yang B, Sun B, Zeng M]
...
- **Study type**: Observational cohort with pre/post methimazole treatment comparison
- **Population**: 18 newly diagnosed untreated GD (UGD) patients, 10 GD patients post-methimazole treatment (TGD), 11 healthy controls (NC); from Shanghai Fifth People's Hospital
- **Methods**: 16S rRNA gene sequencing (V3-V4 region), 16S rDNA amplification on Illumina platform; Greengenes database for OTU classification
- **Diversity findings**: Alpha diversity (observed OTUs, Shannon, Simpson) significantly reduced in UGD vs NC (P < 0.05); TGD diversity significantly improved vs UGD (observed OTUs P=0.002, Shannon P=0.016)
- **Phylum-level changes**: Actinobacteria, Cyanobacteria, TM7 significantly increased in UGD vs NC; Firmicutes and [Thermi] decreased (P < 0.017)
- **Genus-level changes in UGD**: Collinsella and Bifidobacterium significantly higher than NC and TGD; Dialister and Roseburia significantly lower
- **Post-treatment (TGD vs UGD)**: Ruminococcus, Streptococcus, Blautia decreased; Phascolarctobacterium increased
- **Correlation analysis**: Bifidobacterium positively correlated with TRAb (r=0.588) and TPOAb (r=0.578); Synergistetes negatively correlated with TRAb (R=-0.702), TGAb (R=-0.624), TPOAb (R=-0.711); Lactobacillus positively correlated with TRAb (R=0.489) and TPOAb (R=0.607)
- **Venn analysis**: 2177 OTUs shared among all three groups; NC had 409 unique OTUs, UGD 488, TGD 191
