...
- **Study design**: Pilot interventional study; 20 clinically similar RRMS patients, 10 on HV/LP diet, 10 on WD, followed for >= 12 months
- **Microbiota analysis**: 16S V4 rRNA sequencing; 1,550 OTUs from 8,852,375 combined sequences; 93% classified at kingdom level
- **Phylum-level**: Firmicutes dominant (~75%) in both groups; Euryarchaeota significantly more abundant in WD patients (p = 0.03)
- **Family-level**: Lachnospiraceae significantly more abundant in HV/LP (29.5% vs 21.8%; p = 0.04); Veillonellaceae significantly different (p = 0.005)
- **Alpha diversity**: No significant difference between diet groups (observed OTUs or Shannon index)
- **Immune parameters**: Flow cytometry on PBMCs at enrollment; HV/LP group had significantly fewer CD4+/IL-17+ cells and CD4+/PD-1+ cells, and more CD14+/PD-L1+ monocytes
- **Correlations in HV/LP group**: Lachnospiraceae with CD14+/IL-10+ monocytes (R = 0.77, p = 0.008), CD14+/TGFbeta+ monocytes (R = 0.73, p = 0.01), and CD4+/CD25+/FoxP3+ Tregs (R = 0.68, p = 0.02)
- **Clinical outcomes**: EDSS improved in HV/LP but worsened in WD (p = 0.001 between groups); relapse rate significantly lower in HV/LP
- **Limitations**: Small sample size (N = 20); no baseline microbiota samples; observational dietary assignment not randomized
