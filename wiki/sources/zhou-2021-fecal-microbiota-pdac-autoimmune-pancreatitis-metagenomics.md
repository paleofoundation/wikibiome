...
created: 2026-04-09
updated: 2026-04-09
authors: [Wenli Zhou, De Zhang, Zhengpeng Li, Huiqing Jiang, Jingnan Li, Rongrong Ren, Xuefeng Gao, Jianfeng Li, Xin Wang, Weifeng Wang, Yunsheng Yang]
...
- **Study design**: 32 PDAC, 32 autoimmune pancreatitis (AIP), 32 healthy controls; Illumina HiSeq shotgun sequencing (~45.3 million reads/sample)
- **Composition**: PCoA showed significant separation between PDAC and HC (PERMANOVA p < 0.001); Firmicutes/Bacteroidetes ratio decreased in PDAC
- **Species-level**: *Faecalibacterium prausnitzii*, *Roseburia intestinalis* decreased in PDAC; *Veillonella dispar*, *Streptococcus parasanguinis* increased in both PDAC and AIP
- **Co-abundance gene groups (CAGs)**: 21 CAGs significantly different between groups; *Faecalibacterium sp.*, *Roseburia intestinalis*, *Clostridium bolteae* decreased only in PDAC
- **Functional analysis**: PDAC enriched in KO modules for bacterial virulence (type II secretion); depleted in SCFA synthesis-associated modules
- **SCFA measurement**: Gas chromatography confirmed significantly decreased fecal butyrate in PDAC patients
- **Biomarker ROC**: *E. rectale* AUC 90.74% (PDAC/HC), *E. ventricosum* 88.89% (PDAC/HC), *O. splanchnicus* 76.54% (AIP/HC)
