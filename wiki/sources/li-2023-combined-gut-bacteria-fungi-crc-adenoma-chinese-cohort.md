...
created: 2026-04-09
updated: 2026-04-09
authors: [Xiaopeng Li, Jiahui Feng, Zhanggui Wang, Gang Liu, Fan Wang]
...
- A total of 51 bacterial and 8 fungal species were significantly associated with HC, CRA, CRC, and PP groups; beta diversity differed significantly between CRC and healthy controls
- *Fusobacterium nucleatum*, *Bifidobacterium bifidum*, *Candida albicans*, and *Saccharomyces cerevisiae* showed significantly increasing trends in CRC vs healthy controls (p < 0.01)
- A highly significant negative correlation between bacterial and fungal data was established for all comparisons (R = -0.17 to -0.32), suggesting antagonistic interactions
- *Candida*, *Byssochlamys*, *Phaeophaeria*, *Gibberella*, and *Mycosphaerella* were the main fungal genera across all four groups
...
- [[dysbiosis]] -- combined bacterial and fungal profiling reveals cross-kingdom dysbiosis patterns through the adenoma-carcinoma sequence
