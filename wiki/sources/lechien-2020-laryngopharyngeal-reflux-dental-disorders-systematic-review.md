...
created: 2026-04-09
updated: 2026-04-09
authors: [Lechien JR, Chiesa-Estomba CM, Calvo Henriquez C, Mouawad F, Ristagno C, Barillari MR, Schindler A, Nacci A, Bouland C, Laino L, Saussez S]
journal: PLoS ONE
year: 2020
...
- LPR incidence ranges from 10-30% of Western populations and is increasing with modern lifestyle and dietary habits

## Methods/Findings

- **Study type**: Systematic review following PRISMA
- **Search**: PubMed, Cochrane Library, Scopus
- **Included**: 24 studies investigating reflux and dental disorders (dental erosion, caries, gingivitis, periodontitis)
- **Dental outcomes**: Assessed via Tooth Wear Index (erosion), Decayed Missing Filled Index (caries), Papillary Marginal Attached Index (gingivitis), PMA Index (periodontitis)
- **Limitation**: Heterogeneity between studies in diagnostic methods and clinical outcome evaluation precluded meta-analysis

## Connections

- Oral microbiota gap in reflux research connects to salivary microbiome findings in [[kawar-2021-salivary-microbiome-gerd-ppi]]
- Dental erosion from acid reflux relates to pH-driven microbial shifts in oral cavity
- LPR-GERD overlap extends the oral-esophageal microbiome axis in [[deshpande-2018-esophageal-microbiome-signatures-host-genetics]]
- Salivary buffering capacity changes relate to [[dysbiosis]] mechanisms in untreated GERD
