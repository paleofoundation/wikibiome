...
- **Scope**: Upper GI tract carcinogenesis (oral cavity, pharynx, esophagus, stomach) focusing on bacteria-host interactions
- **Cancer types reviewed**: Head and neck squamous cell carcinoma (HNSCC, 4.9% of cancers, 40% 5-year survival), esophageal cancer, gastric cancer
- **Mechanisms**: Chronic inflammation, altered signaling (NF-kB, STAT3), genotoxins (ROS, RNI), metabolic reprogramming
- **Bacterial changes in smokers**: Increased *Parvimonas*, *Fusobacterium*, *Bacteroides*, *Porphyromonas*, *Campylobacter*; decreased *Veillonella*, *Neisseria*, *Streptococcus*

## Connections

- Upper GI carcinogenesis pathway extends Barrett's esophagus progression in [[gail-2015-upper-gi-microbiome-barretts-genomic-instability]]
- Smoking-microbiome disruption connects to inhalational exposure GERD risk in [[kim-2025-inhalational-exposure-gastroesophageal-disease-meta-analysis]]
- *Fusobacterium* involvement parallels esophageal community type findings in [[deshpande-2018-esophageal-microbiome-signatures-host-genetics]]
- Oral microbiome-cancer link extends to GERD-related oral dysbiosis in [[kawar-2021-salivary-microbiome-gerd-ppi]]
- Host-pathogen interaction framework provides context for [[dysbiosis]]-driven GERD pathogenesis
