---
title: "Wang 2023 — Gut Microbiota Signature in Children with ASD Who Suffered from Chronic Gastrointestinal Symptoms"
type: source
created: 2026-04-09
updated: 2026-04-09
authors: [Hui Wang, Shu Liu, Liqing Xie, Jinhui Wang]
year: 2023
journal: "BMC Pediatrics"
doi: "10.1186/s12887-023-04292-8"
tags: [autism-spectrum-disorder, gut-microbiota, gastrointestinal-symptoms, 16S-rRNA, Streptococcus, Ruminococcus, Ruminiclostridium, Flavonifractor, alpha-linolenic-acid, metabolic-pathways]
...
## GI Symptom Prevalence in ASD Cohort
- Constipation: 45.24%
- Diarrhea: 33.33%
- Dysphagia: 23.81%
- Anorexia: 23.81%
- Selective eating: 42.86%
- Food allergy: 7.14%

## Alpha and Beta Diversity
- **Alpha diversity**: no significant difference in Shannon (p = 0.69) or Simpson indices (p = 0.073)
- However, significant differences in **species richness** (observed species p < 0.05, Chao1 p < 0.05, ACE p < 0.05)
- **Beta diversity**: significant PCoA separation (p = 0.013)
- LDA analysis confirmed distinct dominant bacteria profiles

## Differentially Abundant Taxa

### Dominant in Healthy Controls
...
### Depleted in ASD
- **[[flavonifractor]]** (p < 0.05)
- *UBA1819* (p < 0.05)
- **[[acinetobacter]]** (p < 0.05)

## Correlation with ASD Severity (CARS)
- *g_Ruminococcus_1* negatively correlated with CARS (higher abundance = lower severity)
- *g_Acinetobacter* and *g_Flavonifractor* positively correlated with CARS

## Metabolic Pathway Differences (KEGG/COG)
- **Alpha-linolenic acid metabolism**: significantly reduced in ASD
- **Uncharacterized conserved protein**: substantially decreased in ASD
- **Aminoglycoside phosphotransferase**: increased in ASD
...
- Southeast coastal Chinese population (Fujian Province)
- Excluded children on antibiotics, probiotics, or supplements within 3 months
- Some children receiving behavioral interventions (ABA, ESDM) — potential confound
- Small sample size limits statistical power
- No dietary data collected
