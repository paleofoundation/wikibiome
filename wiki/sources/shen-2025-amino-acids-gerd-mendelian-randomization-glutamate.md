...
- **Study type**: Omics Mendelian randomization combined with meta-analysis
- **Data sources**: Finngen R10 database (28,859 cases, 350,064 controls) and UK Biobank (29,975 cases, 390,256 controls) for GERD; GWAS metabolomics for 20 amino acids from 14 cohorts (24,925 participants) and 2 European cohorts (7,824 participants)
- **Amino acids tested**: Aspartate, glutamate, glycine, arginine, threonine, cysteine, proline, serine, guanidinoacetate, tryptophan, methionine, tyrosine, valine, alanine, leucine, isoleucine, phenylalanine, glutamine, histidine
- **SNP thresholds**: Adjusted per amino acid (5e-7 for most; 5e-6 for arginine, cysteine, glycine, isoleucine, methionine; 5e-5 for glutamate and aspartate)
- **Methods**: IVW primary; MR-Egger, weighted median; MR-PRESSO for outlier detection; Bonferroni FDR correction
- **Meta-analysis**: Combined IVW results from Finnish and UK databases; beta values consistent in direction
