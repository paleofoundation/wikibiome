...
- Gender is a specific factor in heavy metal effects on gut microbiota

# Methods/Findings

- **Study type**: Narrative review of literature across animal and human studies
- Comprehensive tables (Tables 1-3) catalog metal-specific effects on microbiota composition, metabolites, and gut barrier across experimental models (mice, rats, fish, humans)
- As exposure: increases Bacteroidetes, Bilophila; perturbs bile acid homeostasis, amino acid metabolism; gut microbiota can methylate As into less toxic forms
- Hg/MeHg exposure: alters gut-brain related metabolites; increases pathogenic Streptococcus, Enterococcus; neurotoxicity via gut-liver axis
