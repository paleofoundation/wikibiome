...
created: 2026-04-09
updated: 2026-04-09
authors: [Ramezani M, Reisian M, Sajadi Hezaveh Z]
journal: PLoS ONE
year: 2023
...
- **TSH results**: No significant within-group or between-group changes (p>0.05)
- **FT4 results**: Significant increase in both groups (synbiotic: mean change 2.43 +/- 5.03, P=0.03; placebo: 2.87 +/- 5.80, P=0.02); ANCOVA showed no between-group difference (P=0.75)
- **Depression**: Non-significant reduction in synbiotic group (mean change -1.15 +/- 5.04) vs. increase in placebo (0.04 +/- 6.25)
- **QoL**: After ANCOVA adjustment, perceived mental health (p=0.02), bodily pain (p=0.02), and general health perceptions (p=0.002) remained significantly improved in synbiotic vs. placebo
- **Adherence**: 91.37%; no adverse effects reported
- **Demographics**: Mean age ~48 years, ~84% female, ~80% autoimmune hypothyroidism, mean hypothyroidism duration ~10 years

## Connections

- QoL improvement without TSH change parallels [[abbott-2019-aip-diet-hashimotos-lifestyle-intervention]] AIP findings
