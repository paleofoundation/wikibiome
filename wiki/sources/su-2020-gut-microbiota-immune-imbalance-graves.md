...
- **Study type**: Cross-sectional case-control study with 16S rRNA sequencing and metagenomic analysis
- **Population**: Newly diagnosed, untreated GD patients and age/sex-matched healthy controls
- **Alpha diversity**: Shannon, Simpson, and observed OTUs significantly reduced in GD (P < 0.01)
- **Beta diversity**: Clear separation on PCoA (weighted UniFrac); PERMANOVA P < 0.001
- **Phylum level**: Decreased Bacteroidetes, increased Firmicutes in GD; Firmicutes/Bacteroidetes ratio elevated
- **Genus level**: Bacteroides (P < 0.001), Alistipes (P < 0.01), and Parabacteroides (P < 0.05) depleted; Prevotella (P < 0.01), Veillonella (P < 0.01), Megasphaera, and Ruminococcus gnavus enriched in GD
- **Gut permeability markers**: Serum LPS significantly elevated in GD (P < 0.001); serum zonulin elevated (P < 0.01), indicating compromised intestinal barrier
- **Immune correlations**: Bacteroides abundance positively correlated with Treg frequency (r = 0.62, P < 0.001) and negatively with Th17 (r = -0.48, P < 0.01); Prevotella positively correlated with Th17 (r = 0.51, P < 0.01)
- **Functional pathways (PICRUSt/HUMAnN)**: LPS biosynthesis enriched in GD; butyrate synthesis depleted; aromatic amino acid degradation enriched; oxidative phosphorylation pathways altered
- **TRAb correlations**: Prevotella abundance positively correlated with TRAb levels (r = 0.44, P < 0.05); Bacteroides negatively correlated (r = -0.39, P < 0.05)
