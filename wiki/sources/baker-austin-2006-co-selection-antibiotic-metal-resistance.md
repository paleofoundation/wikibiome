...
- Metal contamination in natural environments functions as a selective agent in the proliferation of antibiotic resistance -- a phenomenon termed [[co-selection]]
- Three distinct molecular mechanisms underlie co-selection: (1) **co-resistance** (physical linkage of resistance determinants on same genetic element), (2) **cross-resistance** (same gene conferring resistance to both metals and antibiotics), and (3) **co-regulatory mechanisms** (shared regulatory responses)
- Heavy metals, unlike antibiotics, are not subject to degradation and can subsequently represent a long-term selection pressure that persists indefinitely in the environment
- The role of metals as a component in [[co-selection]] and dissemination of antibiotic resistance has been substantially underappreciated in clinical and environmental research
...
This is the seminal review that established the conceptual framework for understanding how [[heavy-metals]] drive [[antimicrobial-resistance]] through co-selection. It is cited by virtually every subsequent paper in the field and is foundational to the wiki's core thesis that metal contamination -- whether environmental or dietary -- has consequences far beyond direct toxicity. The three-mechanism model (co-resistance, cross-resistance, co-regulation) provides the vocabulary and conceptual scaffolding used throughout the wiki. The paper's argument that metals represent a MORE persistent selection pressure than antibiotics (because they don't degrade) is central to understanding why metal-contaminated environments are reservoirs of antibiotic resistance genes that can transfer to human pathogens.

# Connections

- [[co-selection]] -- this paper defined the modern framework for metal-antibiotic co-selection, establishing the three mechanisms
- [[antimicrobial-resistance]] -- metals identified as a persistent, underappreciated driver of environmental antibiotic resistance
- [[mercury]] -- mercury resistance genes on Tn21 transposons linked to multiple antibiotic resistance cassettes
- [[copper]] -- copper resistance (*tcrB*) co-located with vancomycin (*vanA*) and macrolide (*ermB*) resistance on transferable plasmids
- [[zinc]] -- zinc in livestock feed as growth promoter selects for antibiotic resistance in intestinal bacteria
...
- [[agarwal-2024-airborne-arg-mrg-ewaste-recycling]] -- field validation at e-waste recycling facilities
- [[wales-2015-co-selection-resistance-antibiotics-biocides-metals]] -- expanded review focusing on foodborne pathogens and biocides
