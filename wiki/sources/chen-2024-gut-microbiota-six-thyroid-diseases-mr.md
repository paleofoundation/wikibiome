...
- **Data sources**: GM GWAS from MiBioGen consortium (18,340 participants, 119 genera); thyroid disease GWAS from FinnGen R10 database (European ancestry)
- **Six thyroid diseases studied**: Nontoxic diffuse goiter (NDG, n=906), nontoxic multinodular goiter (NMG, n=6699), nontoxic single thyroid nodule (NSTN, n=2203), Graves' disease (GD, n=4846), Plummer disease (PD, n=1717), thyrotoxicosis with toxic single thyroid nodule (TSTN, n=246)
- **IVs**: 1531 SNPs from 119 genera, all F-statistic >10
- **MR methods**: Five methods used (IVW, weighted median, simple mode, MR-Egger, weighted mode)
- **GD-specific results (IVW)**: Ruminiclostridium9 OR 0.749 (protective); Eubacterium rectale group OR 1.305 (risk); Desulfovibrio OR 1.216; Bifidobacterium OR 1.246; Victivallis OR 0.847; Butyricimonas OR 0.824; Collinsella OR 1.301; Oscillospira OR 1.231; Catenibacterium OR 1.331
- **Sensitivity analysis**: No significant heterogeneity or horizontal pleiotropy detected for GD-associated taxa
- **Cross-disease patterns**: Lachnoclostridium protective for NDG; Bifidobacterium and Sutterella protective for NMG; Butyricimonas protective for both GD and PD
