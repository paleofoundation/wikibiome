...
created: 2026-04-09
updated: 2026-04-09
authors: [Han Z, Cen C, Ou Q, Pan Y, Zhang J, Huo D, Chen K]
...
- Berberine supplementation increased beneficial bacteria [[Lactococcus lactis]] and [[Enterococcus hirae]] while decreasing pathogenic [[Enterobacter hormaechei]] and [[Chryseobacterium indologenes]]
...
- **Study type**: 6-month controlled clinical trial with shotgun metagenomic sequencing
- **Population**: GD patients from Hainan Provincial People's Hospital (2018-2019); methimazole group (n=8) and methimazole + berberine group (n=10)
- **Dosing**: MI group: Methimazole 20mg per tablet, 1 tablet each time once daily; Combined group: MI + Berberine tablets 0.3g per tablet, three tablets each time, three times daily
- **Sequencing**: Shotgun metagenomic sequencing on Illumina HiSeq 2500; MAGs constructed using MetaBAT; GTDB-TK for taxonomic annotation; HUMAN2 for metabolic pathways
- **Thyroid function results**: Both groups returned FT3 to healthy level by 6 months; only combined group restored TSH and FT3 indices to normal; TRAb shifted closer to healthy threshold only with berberine addition
- **MI alone effects**: No significant change in Shannon/Simpson diversity; Bray-Curtis distance not significantly different from baseline; significant pathway changes at 6 months included L-phenylalanine degradation IV, polymyxin resistance, S-adenosyl-L-methionine cycle I
- **MI + Berberine effects**: Bray-Curtis distance significantly altered from baseline (P=0.013) at 6 months; more metabolic pathways significantly changed including TCA cycle, ureide biosynthesis, L-isoleucine biosynthesis, glyoxylate cycle, enterobactin biosynthesis
- **Key strain changes (combined)**: Blautia wexlerae, Enterococcus hirae, Ruminococcus sp., Faecalibacterium prausnitzii significantly altered; Enterobacter hormaechei and Chryseobacterium indologenes decreased
- **Correlation network**: TSH positively correlated with Faecalibacterium prausnitzii and enterobactin biosynthesis; FT4 negatively correlated with Faecalibacterium prausnitzii and Prevotella jejuni; vitamin K2 biosynthesis pathways (menaquinol) correlated with treatment response
