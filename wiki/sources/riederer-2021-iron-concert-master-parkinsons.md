...
- **Iron-related animal models**: Unilateral intranigral injection of ferric iron at low doses causes time-dependent altered motor behavior in rats with 95% reduction of dopamine concentration in ipsilateral striatum
- **Neuromelanin-associated toxicity**: Alpha-synuclein (a-syn) shows an age-dependent increase; iron binding to a-syn promotes aggregation and Lewy body (LB) formation; neuromelanin-iron interaction creates a toxic cycle
- **Glutathione-iron relationship**: Dramatic loss of GSH in glia suggests dysfunction of GSH uptake into neurons; loss of GSH and increased iron in SNpc may be pre-symptomatic markers of PD
- **COVID-19 connection**: SARS-CoV-2 proteins interact with TMPRSS6/hepcidin pathway, suggesting viral infection could trigger PD in the gut/olfactory system via iron dysregulation
- **Tyrosine hydroxylase-iron relationship**: TH activity in striatum of PD was 60% of controls; TH is stimulated by 1 mM iron (Fe) by 13-fold; the activity of TH interacts with iron and increases in a-syn, leading to reduction in dopamine concentrations
- **Neuromelanin quantitative data**: NM-bound iron in SN of PD shows age-dependent increase; iron binding to NM produces reactive species that damage surrounding neurons; NM granules visible in post-mortem Berlin blue staining (Fe III detection) showing intracytoplasmic deposits in SN neurons
...
- [[iron]] -- central thesis that iron accumulation in the substantia nigra is the primary driver of PD pathology
- [[parkinsons-disease]] -- comprehensive mechanistic review of iron's role in dopaminergic neuron loss
- [[oxidative-stress]] -- iron-catalyzed Fenton reaction generates hydroxyl radicals that damage proteins, lipids, and DNA
- [[gut-brain-axis]] -- bottom-up hypothesis: triggers from gut/olfactory system initiate iron-mediated pathology spreading to brain via vagal nerve
- [[neuroinflammation]] -- activated microglia and astrocytes contribute to neuromelanin-mediated toxic cycle
- [[alpha-synuclein]] -- iron binding promotes a-syn aggregation and Lewy body formation
- [[blood-brain-barrier]] -- BBB disruption at SN site permits unregulated iron uptake
- [[ferroptosis]] -- iron-dependent cell death mechanism central to dopaminergic neuron loss
