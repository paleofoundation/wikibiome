...
- **Study design**: 30 PC patients, 13 healthy subjects, 6 pre-cancerous lesion patients, 16 NAFLD controls; 16S rRNA amplicon sequencing
- **Diversity**: Alpha diversity (Shannon) not significantly different between PC and controls (PC 2.89, PCL 3.04, Control 3.1); NAFLD group more diverse (3.3)
- **Composition shifts**: Firmicutes/Bacteroidetes ratio higher in PC vs controls; weak but significant ANOSIM separation (p=0.013, R=15%)
- **LEfSe analysis**: Considerable under-representation of Firmicutes taxa (Clostridiales, Lachnospiraceae, Ruminococcaceae) in PC; Bacteroidales increased
- **Classification**: Random Forest AUC 82.5% (CI: 63.6-100%); specificity 0.8, sensitivity 0.769 on validation set
- **Bile duct obstruction**: Different biomarker taxa associated with bile-obstructed vs non-obstructed PC; *Veillonella* associated with biliary obstruction, *Megasphaera* with non-obstructed PC
- **Bilirubin correlations**: Strong negative correlation between Clostridiales abundance and bilirubin levels (Spearman's R = -0.5)
