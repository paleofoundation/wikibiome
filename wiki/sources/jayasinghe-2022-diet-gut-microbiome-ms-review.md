...
created: 2026-04-09
updated: 2026-04-09
authors: [Jayasinghe M, Prathiraja O, Kayani A, Jena R, Caldera D, Silva M, Singhal M, Pierre J Jr]
journal: Cureus
year: 2022
...
- **Design**: Narrative review from multiple institutions (Nanjing Medical University, Allama Iqbal Medical College, Bharati Vidyapeeth, Mahatma Gandhi Medical College)
- **Topics covered**: Gut-brain axis mechanisms, dietary antioxidants (vitamins D, A, C), fatty acids (omega-3 PUFAs, omega-6 PUFAs), curcumin, obesity/adipokines, ketogenic diet, intermittent fasting, MIND diet, FMT, probiotics
- **Key dietary overview figure**: Integrates vitamin A, D, antioxidants, fatty acids, curcumin, MIND diet, KD, IF/caloric restriction, high salt, and obesity effects on MS through the gut microbiome
- **FMT evidence**: FMTs from healthy donors to MS patients demonstrated lower intestinal permeability, anti-inflammatory cytokine balance shift, and enhanced microbiota composition of RRMS patients
- **DMT side effects table**: Catalogues serious adverse effects of interferons, glatiramer, oral immunomodulators, cell-migration modulators, and cell-depleting therapies, motivating dietary alternatives
