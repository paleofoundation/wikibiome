---
title: "Amadi 2022 — Dietary Interventions for ASD: Updated Systematic Review"
type: source
created: 2026-04-09
updated: 2026-04-09
...
- **Multiple dietary models** (GFCF, ketogenic, Mediterranean, low FODMAP, low glutamate, low oxalate) have been applied to ASD with variable results
- **No consensus** exists on an ideal nutritional model for ASD
- **Food selectivity** affects 30-84% of ASD children, complicating dietary interventions
- **Gut-brain axis** is the primary mechanism linking diet to ASD behavioral outcomes

# Methods & Findings

**Design:** Updated systematic review of human dietary intervention studies in ASD.
...
- **GFCF-metal link**: Gluten and casein peptides chelate divalent metals; their removal may alter metal bioavailability in the gut
- **KD-Akkermansia-metal axis**: KD-enhanced Akkermansia muciniphila restores mucin barrier which controls metal permeability
