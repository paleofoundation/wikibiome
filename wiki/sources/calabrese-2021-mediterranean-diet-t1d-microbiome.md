...
doi: "10.3389/fnut.2020.612773"
evidence_level: expert-opinion
sample_size: "N/A"
tags: [type-1-diabetes, mediterranean-diet, dietary-intervention, SCFA, glycemic-control]
library_category: diet
platform: both
condition: "type-1-diabetes"
karen_brain_primitives: [5]
metals_discussed: []
taxa_discussed: [faecalibacterium-prausnitzii, prevotella, lactobacillus]
key_findings:
  - "SEARCH study: Mediterranean diet improved glycemic control and CV risk in T1D youth"
  - "MD promotes F. prausnitzii and butyrate production addressing core T1D dysbiosis"
  - "L. johnsonii N6.2 supplementation alongside MD proposed as T1D-specific intervention"
---

## Key Findings

- **SEARCH study results**: The Mediterranean diet improved glycemic control (lower HbA1c) and cardiovascular risk factors in T1D youth, providing clinical evidence for dietary intervention in established T1D (Calabrese et al. 2021, expert opinion)
...
Informs the **[[faecalibacterium-prausnitzii]]** entity page with dietary modulation data. Supports a concept page on **dietary intervention in autoimmune disease**. The SEARCH study data is relevant to the T1D disease entity page.

## Relevance to Cureva

Provides the evidence base for Mediterranean diet as a validated intervention in the T1D signature. The L. johnsonii N6.2 proposal generates a specific probiotic intervention hypothesis for triangle validation. Dietary fiber as butyrate substrate is a mechanistically grounded intervention.

## Open Questions

- Has L. johnsonii N6.2 been tested in a T1D RCT (not just proposed)?
- Does the Mediterranean diet effect on HbA1c in T1D operate primarily through microbiome modulation or through direct metabolic effects?
