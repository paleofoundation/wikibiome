...
Original research examining the gut fungal microbiome (mycobiome) in 50 healthy controls, 50 hypertension-only (HTN), and 50 hypertension+CKD (HTN+CKD) patients via ITS sequencing. Found distinctive fungal dysbiosis in HTN+CKD comorbidity with cytokine and renal function associations.

## Key Findings

### Fungal Community Composition
- HC dominated by: *Candida* (20.30%), *Aspergillus* (15.25%), *Cladosporium* (13.49%), *Wallemia* (7.77%)
- HTN+CKD: *Malassezia* (18.71%), *Aspergillus* (12.93%), *Candida* (9.76%), *Saccharomyces* (7.38%), *Cladosporium* (6.67%)
- HTN+CKD patients had significantly higher alpha diversity (Chao1, Shannon, Simpson) vs controls and HTN-only
- 13 fungal genera significantly differed between HTN+CKD and controls

### Key Fungal Shifts
- HTN+CKD increased: *Apiotrichum*, *Cystobasidium*, *Saccharomyces*
- HTN+CKD decreased: *Bjerkandera*, *Candida*, *Meyerozyma*
- HTN-only: only 3 genera differed from controls (*Cystobasidium*, *Filobasidium*, *Strelitziana*)

### Cytokine Associations
- HTN+CKD had higher IL2Ralpha, IL18, TNFalpha vs controls
- *Candida* negatively associated with GROalpha, LIF, TNFalpha
- *Saccharomyces* positively associated with IFN-gamma, IL4, LIF, SCF
- *Apiotrichum*, *Saccharomyces*, *Septoria* positively correlated with eGFR
- *Septoria* and *Nakaseomyces* positively associated with blood pressure
