...
sample_size: "n=367441"
tags: [gerd, mendelian-randomization, causal-inference, gut-microbiome, bidirectional]
library_category: causal
platform: both
condition: "gastroesophageal-reflux-disease"
karen_brain_primitives: [1, 5]
metals_discussed: []
taxa_discussed: [lachnospiraceae, methanobrevibacter, actinobacteria, mollicutes, christensenellaceae, collinsella, eggerthella]
key_findings:
  - "Actinobacteria (OR=0.93) and Lachnospiraceae UCG004 (OR=0.91) causally protective"
  - "Mollicutes (OR=1.09) and Tenericutes (OR=1.11) causally increase risk"
  - "Bidirectional: GERD causes dysbiosis in 13 taxa including depleting Christensenellaceae"
---
