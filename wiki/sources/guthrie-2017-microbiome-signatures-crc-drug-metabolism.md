...
- Microbial beta-glucuronidases (BGs) in the gut reactivate the excreted inactive metabolite of irinotecan (SN-38G) to its active toxic form (SN-38), causing severe diarrhea as an adverse drug response
- Two distinct metabolizer phenotypes ("metabotypes") were identified: low (0.04-8.72%) and high (26.46-77.11%) SN-38 formation
- BGs from a predicted uncultered *Clostridium* spp., *Faecalibacterium prausnitzii*, and a *Bacteroides* species were significantly differentially abundant between high and low metabolizers
- BG activity is greater in colorectal cancer patients, and high metabotypes have enriched carbohydrate metabolism pathways
