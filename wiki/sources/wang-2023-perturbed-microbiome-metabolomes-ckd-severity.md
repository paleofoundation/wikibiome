...
sample_size: "n=88"
tags: [chronic-kidney-disease, microbiome, metabolomics, diagnostic-biomarkers, CKD-staging]
...
key_findings:
  - "26 species significantly changed with CKD progression"
  - "Combined microbiome + metabolite diagnostic model achieved AUC 0.972 for mild CKD detection"
  - "Gut microbiome disruption detectable earlier than serum creatinine elevation"
---

## Key Findings

- **26 species significantly changed** across CKD severity stages, with progressive depletion of SCFA producers and enrichment of uremic toxin producers.
- **[[ruminococcus-bromii]]** was the main contributor to the microbial co-occurrence network, acting as a keystone species whose loss cascades through the ecosystem.
- Combined microbiome + metabolite model achieved **AUC 0.972 for detecting mild CKD**, outperforming serum creatinine alone.
...
- **[[faecalibacterium-prausnitzii]]** and source-labeled **[[agathobacter-rectalis|Eubacterium rectale]]** were depleted (SCFA loss), while **[[citrobacter]]** and **[[flavonifractor]]** were enriched (uremic toxin production).
