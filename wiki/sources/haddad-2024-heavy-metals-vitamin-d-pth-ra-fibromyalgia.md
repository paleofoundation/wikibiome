...
- **Design**: Case-control study; 60 adults (20 RA, 20 FMS, 20 controls) from Al-Zahraa University Hospital, Cairo, Egypt (Nov 2021 - Sept 2023)
- **Measurements**: Serum lead, aluminium, cadmium, chromium; vitamin D3 and PTH by ELISA
- **RA group**: Mean lead 9.66 ug/dl, Cd 0.055 ug/dl, Cr 0.53 ug/dl
- **Control group**: Mean lead 7.47 ug/dl, Cd 0.028 ug/dl, Cr 0.38 ug/dl
- Strong inverse correlations in RA: VitD-Lead (r=-0.969), VitD-Cd (r=-0.901), VitD-Cr (r=-0.925)
- In FMS: Lead had significant independent risk on VD level; Cd and Cr also correlated
- ROC curve analysis performed for sensitivity/specificity
