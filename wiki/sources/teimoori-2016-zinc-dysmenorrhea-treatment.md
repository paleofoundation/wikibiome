...
created: 2026-04-09
updated: 2026-04-09
authors: [Teimoori B, Ghasemi M, Hoseini ZSA, Razavi M]
...
- Combination of [[zinc]] sulfate (220 mg once daily) plus mefenamic acid significantly reduces primary [[dysmenorrhea]] pain severity: mean pain score decreased from 5.3 +/- 1.8 to 1.2 +/- 1.9 (p < 0.001)
- Mefenamic acid plus placebo also reduced pain (5.8 +/- 2.1 to 2.9 +/- 2.6, p < 0.001), but the zinc combination group showed greater absolute pain reduction (4.1 vs 2.9 points)
- 64% of patients in the zinc + mefenamic acid group did not develop dysmenorrhea after treatment vs 33% in the control group (p < 0.001)
- Zinc inhibits prostaglandin metabolism in the uterus, enhances microcirculation, and acts as an anti-inflammatory agent similar to NSAIDs

# Methods/Findings

- **Design**: Randomized, double-blind clinical trial
- **Participants**: 200 university students aged 18-26 with primary dysmenorrhea and regular menstrual cycles (28 +/- 7 days) from Zahedan University of Medical Sciences, Iran
...
- Included as one of 6 RCTs in [[hsu-2024-zinc-dysmenorrhea-meta-analysis]] which confirmed the overall efficacy of zinc for dysmenorrhea
