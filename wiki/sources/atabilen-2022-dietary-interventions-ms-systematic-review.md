...
created: 2026-04-09
updated: 2026-04-09
authors: [Atabilen B, Akdevelioglu Y]
...
- **Design**: Systematic review following PRISMA criteria; searched PubMed, Web of Science, and Cochrane Library (February-March 2022)
- **Included studies**: 17 studies (only RCTs, cross-sectional, or prospective human studies in adults; excluded animal studies, pediatric, meta-analyses)
- **Caloric restriction/IF findings**: Improvements in emotional well-being and depression; decreased memory T cells; *Faecalibacterium*, *Lachnospiracea Incertae sedis*, and *Blautia* showed increasing trends after 15 days of IF
- **Ketogenic diet findings**: 6 studies reviewed; anti-inflammatory mechanisms include NLRP3 pathway inhibition (reducing IL-1beta/IL-18), PPAR activation, ROS reduction, GABA increase, and histone acetylation
- **Key diet comparison table**: Detailed comparison of 7 diet models (MCT-ketogenic, modified Paleolithic, Wahls, Swank, McDougall, Mediterranean, MIND) across food categories
...
- The gluten-free diet section connects to and intestinal transglutaminase-2 pathways that may link celiac-like responses to MS neuroinflammation
- Highlights the gap in -focused dietary trials: most included studies did not incorporate gut microbiome analysis as an outcome measure
