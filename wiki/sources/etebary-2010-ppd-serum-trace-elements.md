...
- [[zinc]], [[magnesium]], [[iron]], and [[copper]] are all implicated in the pathophysiology and treatment of [[postpartum-depression]]
- **Zinc** deficiency is associated with depression; lower zinc blood concentrations are found in women with PPD; zinc adjusts excitatory and inhibitory neurotransmission pathways
- **Magnesium** deficiency can cause psychiatric symptoms including depression, headaches, tremors, and anxiety; depletion during pregnancy is hypothesized to contribute to PPD; Mg supplementation has shown mood-stabilizing properties
- **Iron** deficiency is the most common single nutrient deficiency worldwide; low hemoglobin is a risk factor for PPD; iron is essential for [[dopamine]] synthesis
- **Copper** levels are elevated in women with a history of PPD; copper deficiency can reduce catecholamine concentrations in the brain
- Trace element supplementation may be an alternative treatment for PPD without adverse effects on breast milk
