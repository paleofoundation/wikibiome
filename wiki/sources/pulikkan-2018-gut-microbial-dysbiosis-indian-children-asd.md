---
title: "Pulikkan 2018 — Gut Microbial Dysbiosis in Indian Children with Autism Spectrum Disorders"
type: source
created: 2026-04-09
updated: 2026-04-09
...
tags: [autism-spectrum-disorder, dysbiosis, 16S-rRNA, gut-microbiota, Lactobacillus, Indian-population, random-forest, Prevotellaceae, Bifidobacteraceae]
...
- **Alpha diversity** (Shannon, observed species, phylogenetic diversity): no significant difference between ASD and healthy
- **Beta diversity** (unweighted UniFrac, PCA): autism correlated significantly with PC3 (Pearson's r, FDR-adjusted P < 0.05)
- Separate PCA clustering of ASD vs healthy samples confirmed compositional differences
...
- **Firmicutes** higher in ASD (56% vs 46%)
- **Bacteroidetes** higher in healthy (46% vs 37%)
...
- Indian population — unique dietary and environmental context (vegetarian diets, different metal exposures)
- ASD children had significantly lower BMI (p = 0.02) and higher male proportion (p = 0.006)
- V3 region of 16S rRNA — limited taxonomic resolution at species level
- CARS score > 36.5 for ASD inclusion (high severity threshold)
- No dietary data collected — potential confound given Indian dietary patterns
