...
1. **Glycolysis**: Glucose → pyruvate (via Embden-Meyerhof pathway or other routes)
2. **End-point metabolism**: Pyruvate → acetyl-CoA (or other intermediates) → fermentation end products
...
- **[[inflammatory-bowel-disease]]** — Loss of [[lachnospiraceae]] (butyrate producers) and shift to proteolytic [[bacteroides-fragilis|bacteroides]]; butyrate deficiency impairs barrier function; toxic fermentation end products drive inflammation.
...
- **[[obesity]]** — SCFA-producing [[bacteroides-fragilis|bacteroidetes]] reduced; caloric extraction and metabolism shift.
...
- Elevated iron + hepcidin → [[lachnospiraceae]] outcompeted by siderophore-producing [[bacteroides-fragilis|bacteroides]].
