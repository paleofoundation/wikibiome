...
- This can converge on some of the same inflammatory mediators generated by bacterial LPS signaling via [[tlr4|TLR4]], even though the initiating exposure and evidence for each pathway differ.
...
### NLRP3 Inflammasome
- Heavy metals activate the [[nlrp3-inflammasome|NLRP3 inflammasome]], a multiprotein complex that drives IL-1beta and IL-18 maturation and release.
