...
No enteral nutrition
       │
       ├── Gut starved of fiber/prebiotics → SCFA producer depletion
       ├── Mucosal atrophy → barrier failure → translocation
       └── Parenteral iron → feeds gut Proteobacteria via luminal diffusion
                                        │
                                        ▼
                              Dysbiosis ← → Infection risk
```
