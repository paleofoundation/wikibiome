...
- **Mycobactins and carboxymycobactins**: Produced by *M. tuberculosis*. Mycobactins are hydrophobic (cell-associated); carboxymycobactins are hydrophilic (secreted). Species-specific side chain variations enable diagnostic identification [[[patil-2021-infection-metallomics-critical-care]]].
