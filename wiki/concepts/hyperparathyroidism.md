...
```
Heavy metal exposure (Pb, Cd, Cr, Al)
            │
            ▼
Impaired renal 1-alpha hydroxylation of 25(OH)D
            │
            ▼
Vitamin D deficiency (reduced 1,25(OH)2D)
            │
            ▼
Reduced intestinal calcium absorption
            │
            ▼
Low serum calcium → PTH elevation (secondary hyperparathyroidism)
            │
            ▼
...
This creates a dangerous feedback loop in lead-exposed individuals:
```
Lead exposure → bone storage of Pb
       ↓
Metal-driven VitD deficiency → secondary hyperparathyroidism
       ↓
PTH-driven bone resorption → Pb mobilization from bone
       ↓
Re-elevated blood Pb → further VitD disruption
```

## CKD-Related Hyperparathyroidism

[[chronic-kidney-disease|Chronic-kidney-disease]] is the most common cause of secondary hyperparathyroidism:
