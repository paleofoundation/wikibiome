...
sources: [islam-2022-opposing-microbiome-signatures-autoimmune-cancer, chen-2024-gut-microbiota-six-thyroid-diseases-mr]
source_count: 2
tags: [oxalate, calcium-oxalate, kidney-stones, Oxalobacter, metal-bioavailability, chelation, nephrolithiasis]
...
**Oxalate** (ethanedioic acid, C2O4^2-) is a small dicarboxylic acid found in many plant foods that has outsized significance for mineral metabolism and kidney health. In the gut, oxalate's fate is determined by a single specialist bacterium -- **[[oxalobacter|Oxalobacter formigenes]]** -- whose presence or absence controls whether oxalate is degraded harmlessly or absorbed to form kidney stones. This makes the oxalate-Oxalobacter system one of the clearest examples of a critical microbial function with no functional redundancy.
...
**[[oxalobacter|Oxalobacter formigenes]]** is the gut's only dedicated oxalate-degrading specialist:
...
When *O. formigenes* is present:
```
Dietary oxalate → (O. formigenes: oxalyl-CoA decarboxylase) → CO2 + formate
                                                                 ↓
                                                         Calcium freed from
                                                         Ca-oxalate complexes
                                                                 ↓
                                                         Improved Ca, Fe, Zn,
                                                         Mg bioavailability
```

When *O. formigenes* is absent:
```
Dietary oxalate → intestinal absorption → blood → kidney filtration
                                                        ↓
                                              Ca-oxalate crystallization
                                                        ↓
                                              Kidney stones (80% of all stones)
```
