...
title: "STOP: Isolated Zinc Supplementation for PCOS"
type: stop
created: 2026-04-11
updated: 2026-04-11
sources: [smovrsnik-2023-heavy-metals-oxidative-stress-pcos, jiang-2021-copper-pcos-meta-analysis]
tags: [pcos, reproductive, supplementation, zinc]

condition: "[[pcos]]"
intervention: "Isolated zinc supplementation"
conventional_rationale: "Patient has low serum zinc — supplementation corrects the deficiency and supports immune and reproductive function"
why_counterproductive: "Zinc data in PCOS are inconsistent across studies. Over-supplementation favors Gram-negative pathobionts that express zinc-dependent metalloproteinases and may increase oxidative stress via Fenton-like reactions. Isolated zinc supplementation in dysbiosis contexts has not been clinically validated and may worsen the dysbiotic ecology."
...
- **[[escherichia-coli|E. coli]]** — zinc-dependent metalloproteinases for tissue invasion
- **[[bacteroides-fragilis|B. fragilis]]** — zinc-dependent BFT (Bacteroides Fragilis Toxin) that cleaves E-cadherin and disrupts intestinal barrier
- **[[zinc-metalloprotease|Zinc metalloproteases]]** across multiple pathobionts use zinc as a cofactor for host tissue degradation
...
- **Restore microbial ecology first** — fiber, [[lactobacillus|Lactobacillus]], [[bifidobacterium|Bifidobacterium]] probiotics to suppress zinc-dependent pathobionts through competitive exclusion.
