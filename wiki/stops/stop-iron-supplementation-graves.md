---
title: "STOP: Iron Supplementation for Graves' Disease"
type: stop
created: 2026-04-11
updated: 2026-04-20
...
tags: [graves-disease, thyroid, autoimmune, supplementation, iron, nutritional-immunity, siderophores]
cureva_status: complete

condition: "[[graves-disease]]"
intervention: "Iron supplementation"
conventional_rationale: "Patient presents with anemia or low serum iron — standard of care prescribes iron supplementation to correct laboratory deficiency"
why_counterproductive: "In Graves' disease, hepcidin elevation indicates functional anemia driven by host nutritional immunity, not true iron deficiency. Oral iron supplementation feeds siderophore-producing pathobionts (Proteobacteria, E. coli, Klebsiella) that are already enriched in the Graves' dysbiotic gut signature, amplifying the iron-rich pro-inflammatory environment and worsening gut-thyroid axis dysfunction. Additionally, iron-rich diets reduce gut microbial diversity, and Graves' patients already exhibit decreased Firmicutes and increased Bacteroidetes — a pattern exacerbated by excess luminal iron. The Graves' gut microbiome is characterized by increased Bacteroidetes, Prevotella, Yersinia enterocolitica, and decreased Faecalibacterium prausnitzii, Bifidobacterium adolescentis, and Akkermansia muciniphila — all patterns worsened by iron excess."
evidence:
  - bao-2024-iron-homeostasis-intestinal-immunity-gut-microbiota
  - su-2020-gut-microbiota-immune-imbalance-graves
  - kravchenko-2023-thyroid-hormones-minerals-aitd
...
alternative: "Support nutritional immunity with [[lactoferrin]] — chelates iron away from pathogens while supporting the host's iron defense strategy. Address underlying dysbiosis to restore physiological iron handling. If true iron deficiency is confirmed (low ferritin with low hepcidin), consider IV iron to bypass the gut microbiome entirely rather than oral supplementation."
...
*Yersinia enterocolitica* deserves special attention in Graves' disease. This bacterium has been found at higher prevalence in GD patients, and antibodies to Y. enterocolitica cross-react with the TSH receptor — a molecular mimicry mechanism potentially driving autoantibody production ([[su-2020-gut-microbiota-immune-imbalance-graves]], cross-sectional). Yersinia is a highly efficient siderophore producer that thrives in iron-rich environments. Oral iron supplementation directly supports its growth and persistence in the gut, potentially amplifying the molecular mimicry signal that drives Graves' pathogenesis.
...
|--------|---------|---------------|
| [[bao-2024-iron-homeostasis-intestinal-immunity-gut-microbiota]] | Iron homeostasis and intestinal immunity; hepcidin-mediated iron sequestration as host defense | Cross-sectional |
| [[su-2020-gut-microbiota-immune-imbalance-graves]] | Altered gut microbiota with increased Proteobacteria and Yersinia in GD; immune imbalance | Cross-sectional |
| [[kravchenko-2023-thyroid-hormones-minerals-aitd]] | Thyroid hormones and minerals in AITD; iron status reflects inflammatory state | Cross-sectional |
| [[zhu-2024-intestinal-microbiota-gut-thyroid-axis-hashimotos]] | Iron deficiency associated with higher TSH and lower fT4; microbiota regulates mineral absorption | Expert-opinion |
| [[wang-2025-gut-microbiome-thyroid-cancer-review]] | Iron-poor diet hinders bacterial growth; iron-rich diet reduces diversity | Expert-opinion |
| [[fang-2024-gut-microbiota-thyroid-disease-advances]] | GD microbiota shows decreased SCFA producers and increased Proteobacteria | Expert-opinion |

## Limitations

- No RCT has directly tested the effect of oral iron supplementation on Graves' disease outcomes or gut microbiome composition in GD patients
- The mechanistic reasoning is built from cross-sectional microbiome data and in vitro/animal iron-microbiome studies
- Hepcidin testing is not routinely available in all clinical settings
- Some GD patients may have genuine concurrent iron deficiency (e.g., from menstrual losses) requiring iron replacement

## Open Questions

- Whether a prospective study of oral iron supplementation in GD patients would show worsened gut microbiome and clinical outcomes
- The optimal lactoferrin dosing and formulation for GD patients with functional iron deficiency
- Whether IV iron in GD patients with true deficiency avoids the microbiome-mediated adverse effects
- The prevalence of Yersinia enterocolitica in GD patients across different geographic populations
