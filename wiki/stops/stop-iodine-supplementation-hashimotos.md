...
title: "STOP: Iodine Supplementation for Hashimoto's Thyroiditis"
type: stop
created: 2026-04-13
updated: 2026-04-13
sources: [gong-2024-iodine-gut-microbiota-hashimotos, brock-2015-selenium-thyroid-autoimmunity, kravchenko-2023-thyroid-hormones-minerals-aitd, li-2025-trace-elements-autoimmune-thyroid-disease]
tags: [hashimotos-thyroiditis, thyroid, autoimmune, supplementation]

condition: "[[hashimotos-thyroiditis]]"
intervention: "Iodine supplementation"
conventional_rationale: "Thyroid needs iodine for hormone synthesis — supplementation supports thyroid function in hypothyroid states"
why_counterproductive: "Excess iodine increases autoantigen load on thyroid peroxidase (TPO), amplifying the autoimmune attack that drives Hashimoto's. The dose-response is U-shaped — excess iodine is as harmful as deficiency. Iodine excess also drives the gut dysbiosis (Proteobacteria enrichment, Lactobacillus/Bifidobacterium depletion) that is characteristic of Hashimoto's, creating a self-reinforcing feed-forward loop."
...
**Iodine excess worsens the Hashimoto's gut dysbiosis.** The Hashimoto's signature features enriched [[proteobacteria|Proteobacteria]], depleted [[lactobacillus|Lactobacillus]] and [[bifidobacterium|Bifidobacterium]], and depleted [[faecalibacterium-prausnitzii]]. High dietary iodine has been shown to shift the gut microbiome in exactly this direction, reducing Lactobacillus and Bifidobacterium abundance and promoting Proteobacteria expansion [[gong-2024-iodine-gut-microbiota-hashimotos]]. This creates a feed-forward loop: iodine supplementation → dysbiosis → immune dysregulation → more anti-TPO → more thyroid destruction.
...
- **Address the gut dysbiosis** — restore [[faecalibacterium-prausnitzii]], [[lactobacillus|Lactobacillus]], and [[akkermansia-muciniphila]] (which has Mendelian randomization evidence for protective effects against Hashimoto's) to normalize gut-thyroid immune crosstalk.
