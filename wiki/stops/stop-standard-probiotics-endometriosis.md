---
title: "STOP: Standard (Unselected) Probiotics for Endometriosis"
type: stop
created: 2026-04-18
updated: 2026-04-18
last_substantive_update: 2026-04-18
sources: [borghini-2020-endometriosis-nickel-ibs, perez-prieto-2024-gut-microbiome-endometriosis-1000-cohort, uzuner-2023-bidirectional-relationship-endometriosis-microbiome, shan-2021-gut-microbiota-hormone-inflammatory-endometriosis, khan-2018-bacterial-contamination-hypothesis-endometriosis, aquino-2012-cadmium-nickel-metalloestrogens]
tags: [endometriosis, probiotics, estrobolome, beta-glucuronidase, estrogen-recirculation]
cureva_status: partial

condition: "[[endometriosis]]"
intervention: "Standard (unselected) probiotic supplementation"
conventional_rationale: "Probiotics are widely recommended for gut health, and endometriosis patients frequently have GI symptoms (bloating, IBS-like symptoms, altered motility). Generic multi-strain probiotics are often prescribed or self-administered to address these gut symptoms."
why_counterproductive: "Many standard probiotic formulations contain species with high beta-glucuronidase activity (particularly E. coli strains and certain Lactobacillus species). Beta-glucuronidase deconjugates estrogen-glucuronides in the colon, driving enterohepatic estrogen recirculation. In endometriosis -- an estrogen-dependent disease -- increasing estrogen recirculation fuels disease progression. The estrobolome dysbiosis in endometriosis is already characterized by enrichment of beta-glucuronidase-producing taxa (E. coli, B. fragilis, E. lenta). Adding unselected probiotics may worsen this dysbiosis pattern rather than correct it."
evidence: [perez-prieto-2024-gut-microbiome-endometriosis-1000-cohort, uzuner-2023-bidirectional-relationship-endometriosis-microbiome, shan-2021-gut-microbiota-hormone-inflammatory-endometriosis]
evidence_level: "prospective-cohort"
alternative: "1) Select specific probiotic strains with LOW beta-glucuronidase activity and demonstrated anti-inflammatory properties (e.g., Lactobacillus rhamnosus GG, specific Bifidobacterium strains). 2) Saccharomyces boulardii -- outcompetes Candida (which provides functional shielding in endometriosis biofilms), binds cadmium and lead, and does not produce beta-glucuronidase. 3) E. coli Nissle 1917 -- outcompetes pathogenic E. coli via superior siderophore systems and lacks virulence genes. 4) Combine selected probiotics with a low-nickel diet to address the full endometriosis ecology."
