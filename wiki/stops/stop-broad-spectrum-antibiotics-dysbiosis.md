---
title: "STOP: Broad-Spectrum Antibiotics for Gut Dysbiosis"
type: stop
created: 2026-04-18
updated: 2026-04-18
...
condition: "Gut [[dysbiosis]] (across conditions)"
intervention: "Broad-spectrum antibiotics"
conventional_rationale: "When pathogenic bacteria are identified or suspected in the gut (e.g., Enterobacteriaceae overgrowth, SIBO, or pathobiont-driven inflammation), the standard approach is to prescribe broad-spectrum antibiotics (fluoroquinolones, metronidazole, rifaximin, amoxicillin-clavulanate) to reduce bacterial load and eliminate pathogens."
why_counterproductive: "Broad-spectrum antibiotics kill commensal competitors (SCFA-producing Firmicutes, Bifidobacterium, Lactobacillus) more effectively than they kill biofilm-protected pathobionts. This deepens dysbiosis rather than correcting it. Metal-tolerant and biofilm-forming organisms (E. coli, Candida, Enterococcus) survive antibiotic exposure within biofilms while their sensitive competitors are eliminated. Furthermore, antibiotic pressure selects for metal-antibiotic co-resistance on mobile genetic elements, creating organisms resistant to both antimicrobials and host nutritional immunity."
evidence: [vangoitsenhoven-2020-microbiome-antibiotics-autoimmune, haag-2015-intestinal-microbiota-innate-immunity-crohns, rebelo-2021-enterococcus-metal-antibiotic-resistance]
evidence_level: "prospective-cohort"
alternative: "1) Ecological engineering (Primitive 5): targeted suppression of pathobionts + restoration of missing beneficial functions. 2) Competitive exclusion: E. coli Nissle 1917 (siderophore competition), Saccharomyces boulardii (anti-Candida). 3) Metal restriction: low-nickel diet (disables urease, hydrogenase, glyoxalase), lactoferrin (iron sequestration). 4) If antibiotics are necessary, use targeted narrow-spectrum agents and follow with ecological restoration (specific probiotics, prebiotics, dietary fiber). 5) Consider HBOT for biofilm disruption in conditions where hypoxia maintains the dysbiotic niche."
karen_brain_primitives: [5, 6, 8, 9]
---
