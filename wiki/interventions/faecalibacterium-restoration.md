---
title: "Faecalibacterium prausnitzii Restoration"
type: intervention
created: 2026-04-14
updated: 2026-04-14
last_substantive_update: 2026-04-14
sources: []
tags: [crohns-disease, cross-condition, faecalibacterium-prausnitzii, butyrate, anti-inflammatory, probiotic]
intervention_class: probiotic
cureva_status: in-progress

triangles:
  - condition: "[[crohns-disease]]"
    I_to_f: "Direct restoration of F. prausnitzii addresses the single most consistently depleted taxon across disease signatures. F. prausnitzii produces butyrate, induces IL-10, suppresses NF-kB, and secretes microbial anti-inflammatory molecule (MAM)."
    I_to_f_evidence: "moderate"
    I_to_f_sources: []
    I_to_D: "Inverse correlation between F. prausnitzii abundance and CD relapse risk established in multiple cohorts; direct oral supplementation trials are in early stages due to oxygen sensitivity of the organism"
    I_to_D_evidence: "prospective-cohort"
    I_to_D_sources: []
    f_to_D: "F. prausnitzii depletion correlates with post-surgical recurrence in CD (prospective cohorts); butyrate deficiency drives epithelial barrier failure and Th17-skewed inflammation"
    f_to_D_sources: []
    status: in-progress
...
targets:
  ...
  enzymes: []
  metals: []
  ecological: [butyrate-restoration, anti-inflammatory, oxygen-gradient-restoration, gut-barrier-repair]
