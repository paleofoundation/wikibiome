---
title: "Citrus Fruits for Endometriosis"
type: intervention
created: 2026-04-14
updated: 2026-04-14
last_substantive_update: 2026-04-14
sources: []
tags: [endometriosis, citrus, naringenin, hesperidin, flavonoids, anti-estrogenic, anti-inflammatory]
intervention_class: dietary
cureva_status: in-progress

triangles:
  - condition: "[[endometriosis]]"
    I_to_f: "Citrus flavonoids (naringenin, hesperidin, nobiletin) inhibit aromatase activity, compete with estradiol at estrogen receptors, and suppress NF-kB-mediated inflammatory signaling. Gut microbiota deglycosylate citrus flavonoid glycosides to produce bioactive aglycones."
    I_to_f_evidence: "preliminary"
    I_to_f_sources: []
    I_to_D: "Epidemiological studies associate higher citrus fruit intake with reduced endometriosis risk; in vitro and animal studies confirm anti-estrogenic and anti-inflammatory effects of naringenin and hesperidin"
    I_to_D_evidence: "cross-sectional"
    I_to_D_sources: []
    f_to_D: "Estrogen excess and NF-kB-driven inflammation are core features of the endometriosis signature; aromatase overexpression in ectopic endometrial tissue drives local estrogen production"
    f_to_D_sources: []
    status: in-progress

targets:
  taxa: [bifidobacterium, lactobacillus]
  enzymes: [aromatase, NF-kB-p65]
  metals: []
  ecological: [anti-estrogenic, anti-inflammatory, prebiotic-polyphenol]
