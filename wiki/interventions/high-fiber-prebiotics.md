---
title: "High-Fiber Prebiotics for Crohn's Disease"
type: intervention
created: 2026-04-14
updated: 2026-04-14
last_substantive_update: 2026-04-14
sources: []
tags: [crohns-disease, prebiotics, inulin, FOS, resistant-starch, butyrate, faecalibacterium]
intervention_class: dietary
cureva_status: partial

triangles:
  - condition: "[[crohns-disease]]"
    I_to_f: "Inulin, FOS, and resistant starch selectively feed depleted butyrate-producing bacteria (Faecalibacterium prausnitzii, Roseburia) that are characteristically lost in Crohn's disease"
    I_to_f_evidence: "moderate"
    I_to_f_sources: []
    I_to_D: "Pilot studies show prebiotic supplementation increases fecal Bifidobacterium and Faecalibacterium in CD patients, with trends toward reduced inflammation; larger RCTs needed"
    I_to_D_evidence: "case-series"
    I_to_D_sources: []
    f_to_D: "F. prausnitzii depletion is the most consistent taxonomic feature of Crohn's disease and correlates with relapse risk; butyrate deficiency drives epithelial barrier failure"
    f_to_D_sources: []
    status: promising
