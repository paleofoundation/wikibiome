---
title: "High-Fiber Diet (Cross-Condition)"
type: intervention
created: 2026-04-14
updated: 2026-04-14
last_substantive_update: 2026-04-14
sources: [carrero-2020-plant-based-diets-ckd-nature-reviews.md]
tags: [cross-condition, dietary-fiber, whole-diet, SCFA, plant-based]
intervention_class: dietary
cureva_status: complete

triangles:
  - condition: "cross-condition"
    I_to_f: "Whole-diet approach emphasizing high fiber intake (>30g/day) from diverse plant sources. Increases microbial diversity, feeds multiple SCFA-producing guilds simultaneously."
    I_to_f_evidence: "strong"
    I_to_f_sources: [carrero-2020-plant-based-diets-ckd-nature-reviews.md]
    I_to_D: "High-fiber dietary patterns associated with reduced all-cause mortality (RR 0.77), reduced CVD, reduced CRC incidence, and improved metabolic markers across multiple meta-analyses"
    I_to_D_evidence: "systematic-review-meta-analysis"
    I_to_D_sources: [carrero-2020-plant-based-diets-ckd-nature-reviews.md]
    f_to_D: "Microbial diversity loss and SCFA depletion are shared features across inflammatory, metabolic, and neuropsychiatric disease signatures"
    f_to_D_sources: [carrero-2020-plant-based-diets-ckd-nature-reviews.md]
    status: validated

targets:
  taxa: [faecalibacterium-prausnitzii, roseburia, prevotella, bifidobacterium, ruminococcus-bromii]
  enzymes: []
  metals: []
  ecological: [diversity-restoration, saccharolytic-shift, SCFA-restoration, gut-barrier-repair]
