---
title: "Saccharomyces boulardii for Endometriosis"
type: intervention
created: 2026-04-14
updated: 2026-04-14
last_substantive_update: 2026-04-14
sources: []
tags: [endometriosis, saccharomyces-boulardii, probiotic-yeast, candida, biofilm, barrier-integrity]
intervention_class: probiotic
cureva_status: partial

triangles:
  - condition: "[[endometriosis]]"
    I_to_f: "S. boulardii competes with pathogenic Candida for adhesion sites and nutrients, disrupts Candida biofilm, secretes anti-toxin factors, and strengthens gut barrier via trophic effects on enterocytes"
    I_to_f_evidence: "moderate"
    I_to_f_sources: []
    I_to_D: "RCTs in other inflammatory GI conditions (IBD, AAD) demonstrate reduced pathogen colonization, improved barrier markers, and anti-inflammatory effects; endometriosis-specific trials are limited"
    I_to_D_evidence: "randomized-controlled-trial"
    I_to_D_sources: []
    f_to_D: "Candida enrichment, biofilm formation, and gut barrier disruption are features of the endometriosis signature; beta-glucuronidase-producing organisms drive estrogen recirculation"
    f_to_D_sources: []
    status: promising
