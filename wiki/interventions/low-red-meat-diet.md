---
title: "Low-Red-Meat Diet for Endometriosis"
type: intervention
created: 2026-04-14
updated: 2026-04-14
last_substantive_update: 2026-04-14
sources: []
tags: [endometriosis, red-meat, heme-iron, arachidonic-acid, estrogen, dietary]
intervention_class: dietary
cureva_status: in-progress

triangles:
  - condition: "[[endometriosis]]"
    I_to_f: "Red meat provides heme iron (feeds iron-dependent pathogens and siderophore producers), arachidonic acid (pro-inflammatory prostaglandin precursor), and is associated with increased estrogen levels via fat content and endocrine disruptors concentrated in animal tissue"
    I_to_f_evidence: "moderate"
    I_to_f_sources: []
    I_to_D: "Prospective cohort studies associate red meat consumption (>2 servings/day) with 56% increased endometriosis risk; inverse association with endometriosis for each serving of red meat replaced by fish"
    I_to_D_evidence: "prospective-cohort"
    I_to_D_sources: []
    f_to_D: "Iron excess, siderophore-producing pathogen enrichment, and prostaglandin-driven inflammation are signature features of endometriosis; heme iron is more bioavailable and less regulated than non-heme iron"
    f_to_D_sources: []
    status: in-progress

targets:
  taxa: [escherichia-coli, enterobacteriaceae]
  enzymes: [siderophores, COX-2]
  metals: [iron]
  ecological: [iron-restriction, anti-inflammatory, estrogen-reduction]
