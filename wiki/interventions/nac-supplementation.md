---
title: "N-Acetylcysteine (NAC) Supplementation (Cross-Condition)"
type: intervention
created: 2026-04-14
updated: 2026-04-14
last_substantive_update: 2026-04-14
sources: []
tags: [cross-condition, NAC, glutathione, oxidative-stress, ASD, schizophrenia, long-covid, glutamate]
intervention_class: supplement
cureva_status: partial

triangles:
  - condition: "cross-condition"
    I_to_f: "NAC is the rate-limiting precursor for glutathione synthesis. Addresses glutathione depletion — a shared signature feature across ASD, schizophrenia, Long COVID, and metal-burdened conditions. Also modulates glutamatergic signaling via cystine-glutamate antiporter."
    I_to_f_evidence: "moderate"
    I_to_f_sources: []
    I_to_D: "Pilot RCTs show NAC improves irritability in ASD (multiple trials), reduces negative symptoms in schizophrenia (adjunctive to antipsychotics), and improves fatigue/cognitive symptoms in Long COVID"
    I_to_D_evidence: "randomized-controlled-trial"
    I_to_D_sources: []
    f_to_D: "Glutathione depletion is documented across ASD, schizophrenia, Parkinson's, and conditions with heavy metal burden; oxidative stress drives neuroinflammation and mitochondrial dysfunction"
    f_to_D_sources: []
    status: promising
...
targets:
  taxa: []
  enzymes: []
  metals: [cadmium, lead, mercury, arsenic]
  ecological: [antioxidant, glutathione-repletion, metal-chelation-support, glutamatergic-modulation]
