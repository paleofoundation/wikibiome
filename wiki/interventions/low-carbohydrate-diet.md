---
title: "Low-Carbohydrate Diet for PCOS"
type: intervention
created: 2026-04-14
updated: 2026-04-14
last_substantive_update: 2026-04-14
sources: []
tags: [pcos, low-carbohydrate, insulin-resistance, hormonal, GERD, dietary]
intervention_class: dietary
cureva_status: partial

triangles:
  - condition: "[[pcos]]"
    I_to_f: "Carbohydrate restriction reduces postprandial insulin spikes, lowering chronic hyperinsulinemia that drives ovarian androgen production. Shifts gut microbiota away from saccharolytic-dependent community (context-dependent — differs from fiber depletion)."
    I_to_f_evidence: "moderate"
    I_to_f_sources: []
    I_to_D: "RCTs and systematic reviews show low-carb diets (<40% energy from carbs) improve fasting insulin, HOMA-IR, total testosterone, and menstrual regularity in PCOS women independent of weight loss"
    I_to_D_evidence: "systematic-review-meta-analysis"
    I_to_D_sources: []
    f_to_D: "Hyperinsulinemia directly stimulates ovarian theca cell androgen production via insulin receptor and IGF-1 receptor signaling; insulin resistance is the central metabolic driver of PCOS"
    f_to_D_sources: []
    status: promising
...
targets:
  ...
  enzymes: []
  metals: []
  ecological: [insulin-reduction, hormonal-rebalancing, anti-inflammatory]
