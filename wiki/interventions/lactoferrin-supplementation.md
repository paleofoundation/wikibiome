---
title: "Lactoferrin Supplementation (Cross-Condition)"
type: intervention
created: 2026-04-14
updated: 2026-04-14
last_substantive_update: 2026-04-14
sources: []
tags: [cross-condition, lactoferrin, iron-sequestration, nutritional-immunity, siderophore, anti-pathogen]
intervention_class: supplement
cureva_status: partial

triangles:
  - condition: "cross-condition"
    I_to_f: "Lactoferrin sequesters free iron from pathogens while delivering iron to host cells via lactoferrin receptors. Disrupts siderophore-dependent iron acquisition by E. coli, Klebsiella, Salmonella, and other iron-dependent pathogens."
    I_to_f_evidence: "strong"
    I_to_f_sources: []
    I_to_D: "RCTs show lactoferrin reduces necrotizing enterocolitis in preterm infants, improves iron status without feeding pathogens in pregnancy, and reduces CRP in inflammatory states"
    I_to_D_evidence: "randomized-controlled-trial"
    I_to_D_sources: []
    f_to_D: "Iron dysregulation and siderophore-producing pathogen enrichment are signature features across IBD, CRC, endometriosis, and CKD; hepcidin elevation indicates functional anemia (host defense), not true deficiency"
    f_to_D_sources: []
    status: promising

targets:
  taxa: [escherichia-coli, klebsiella, salmonella, enterobacteriaceae]
  enzymes: [siderophores, enterobactin, yersiniabactin]
  metals: [iron]
  ecological: [iron-sequestration, anti-biofilm, immunomodulatory]
