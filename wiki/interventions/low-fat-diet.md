---
title: "Low-Fat Diet for Endometriosis"
type: intervention
created: 2026-04-14
updated: 2026-04-14
last_substantive_update: 2026-04-14
sources: []
tags: [endometriosis, low-fat, estrogen, dietary-fat, pain, estrogenic]
intervention_class: dietary
cureva_status: in-progress

triangles:
  - condition: "[[endometriosis]]"
    I_to_f: "Dietary fat modulates estrogen metabolism — adipose tissue aromatase converts androgens to estrogens, and high-fat diets increase enterohepatic estrogen recirculation by promoting bile acid secretion and beta-glucuronidase-producing bacteria"
    I_to_f_evidence: "preliminary"
    I_to_f_sources: []
    I_to_D: "Observational studies suggest reduced endometriosis pain with lower dietary fat intake; small intervention studies show decreased serum estradiol and prostaglandin levels on low-fat diets"
    I_to_D_evidence: "cross-sectional"
    I_to_D_sources: []
    f_to_D: "Estrogen excess drives endometrial lesion growth; beta-glucuronidase-mediated estrogen recirculation is a signature feature of the endometriosis ecosystem"
    f_to_D_sources: []
    status: in-progress

targets:
  taxa: []
  enzymes: [beta-glucuronidase, aromatase]
  metals: []
  ecological: [estrogen-reduction, bile-acid-modulation, anti-inflammatory]
