---
title: "STOP: Iron Supplementation in Schizophrenia with Neuroinflammation"
type: stop
created: 2026-04-14
updated: 2026-04-14
last_substantive_update: 2026-04-14
sources: [ji-2025-polyphenols-schizophrenia-mechanisms-therapeutic-potential.md, ermakov-2022-immune-system-abnormalities-schizophrenia.md, li-2024-alterations-gut-microbiota-schizophrenia-vote-counting.md]
tags: [schizophrenia, iron, neuroinflammation, oxidative-stress, siderophores, nutritional-immunity]
cureva_status: complete

condition: "[[schizophrenia]]"
intervention: "Iron supplementation"
conventional_rationale: "Patient may present with anemia markers or fatigue; clinician assumes iron deficiency and supplements."
why_counterproductive: "Iron feeds Fenton chemistry driving oxidative damage in dopaminergic circuits. Iron-catalyzed reactive oxygen species amplify neuroinflammation and microglial M1 polarization. Iron also feeds siderophore-producing Enterobacteriaceae (enriched in schizophrenia), fueling the LPS-producing pathobiont bloom and worsening gut barrier dysfunction. Polyphenol iron chelation shows therapeutic benefit, indicating that reducing iron availability is therapeutic — the opposite of supplementation."
evidence: [ji-2025-polyphenols-schizophrenia-mechanisms-therapeutic-potential.md, ermakov-2022-immune-system-abnormalities-schizophrenia.md, li-2024-alterations-gut-microbiota-schizophrenia-vote-counting.md]
evidence_level: "review (mechanistic) — no direct RCT comparing iron supplementation harm vs. benefit in schizophrenia"
alternative: "Assess for functional vs. true iron deficiency. If CRP is elevated (28% of schizophrenia patients), consider that low serum iron may represent nutritional immunity (host defense), not true deficiency. Support with [[lactoferrin]] (sequesters iron from pathogens while supporting host absorption) and polyphenol supplementation (curcumin, EGCG) for iron chelation."
karen_brain_primitives: [1, 2, 4, 8]
---

# STOP: Iron Supplementation in Schizophrenia with Active Neuroinflammation
...
- Symptomatic anemia with hemoglobin <10 g/dL — treat the anemia while investigating inflammatory status
