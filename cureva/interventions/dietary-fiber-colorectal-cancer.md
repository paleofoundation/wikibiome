---
title: "Dietary Fiber for Colorectal Cancer Prevention"
type: intervention
created: 2026-04-14
updated: 2026-04-14
last_substantive_update: 2026-04-14
sources: []
tags: [colorectal-cancer, dietary-fiber, butyrate, SCFA, cancer-prevention]
intervention_class: dietary
cureva_status: complete

triangles:
  - condition: "[[colorectal-cancer]]"
    I_to_f: "Dietary fiber is fermented by colonic bacteria into SCFAs, primarily butyrate, which serves as the principal energy source for colonocytes and maintains epithelial barrier integrity"
    I_to_f_evidence: "strong"
    I_to_f_sources: []
    I_to_D: "Meta-analyses of prospective cohorts consistently show 10% CRC risk reduction per 10g/day increase in dietary fiber; dose-response relationship confirmed"
    I_to_D_evidence: "prospective-cohort"
    I_to_D_sources: []
    f_to_D: "Butyrate induces apoptosis in CRC cell lines, inhibits histone deacetylase activity, and suppresses Wnt signaling — direct anti-tumor mechanisms confirmed in vitro and animal models"
    f_to_D_sources: []
    status: validated
